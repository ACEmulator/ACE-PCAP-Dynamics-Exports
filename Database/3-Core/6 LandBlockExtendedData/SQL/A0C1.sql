...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A0C1004, 28552, 0xA0C1000B, 44.76064, 48.52102, 35.61878, 0.7344691, 0, 0, -0.6786422,  True, '2019-02-10 00:00:00'); /* Crystal Spur */
/* @teleloc 0xA0C1000B [44.760640 48.521020 35.618780] 0.734469 0.000000 0.000000 -0.678642 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A0C1005,  1627, 0xA0C1001E, 77.91183, 130.1497, 68.8579, 0.8003034, 0, 0, -0.5995952,  True, '2019-02-10 00:00:00'); /* Tusker Crimsonback */
