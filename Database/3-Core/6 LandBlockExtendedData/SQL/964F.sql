...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7964F003,  9244, 0x964F0009, 36.50029, 11.66566, 11.05686, -0.980676, 0, 0, -0.1956389,  True, '2019-02-10 00:00:00'); /* Pristine Doll */
/* @teleloc 0x964F0009 [36.500290 11.665660 11.056860] -0.980676 0.000000 0.000000 -0.195639 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7964F004, 21164, 0x964F0031, 150.6652, 19.1717, 10.003, -0.1128972, 0, 0, -0.9936067,  True, '2019-02-10 00:00:00'); /* Gout */
/* @teleloc 0x964F0031 [150.665200 19.171700 10.003000] -0.112897 0.000000 0.000000 -0.993607 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7964F005,  9257, 0x964F003A, 179.7139, 24.84972, 11.11938, -0.7476597, 0, 0, -0.664082,  True, '2019-02-10 00:00:00'); /* Silt Lurker */
