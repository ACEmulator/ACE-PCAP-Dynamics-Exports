...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7974F007,  5497, 0x974F000E, 26.43767, 142.2483, 13.88302, -0.8726941, 0, 0, -0.4882672,  True, '2019-02-10 00:00:00'); /* Virindi Director */
/* @teleloc 0x974F000E [26.437670 142.248300 13.883020] -0.872694 0.000000 0.000000 -0.488267 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7974F008,  4104, 0x974F0008, 0.7424469, 182.3231, 15.72, 1, 0, 0, 0,  True, '2019-02-10 00:00:00'); /* High Tumerok */
/* @teleloc 0x974F0008 [0.742447 182.323100 15.720000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7974F009,   226, 0x974F0008, 0.7424469, 180.8231, 15.72, 1, 0, 0, 0,  True, '2019-02-10 00:00:00'); /* High Tumerok */
/* @teleloc 0x974F0008 [0.742447 180.823100 15.720000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7974F00A,  9257, 0x974F0024, 118.6317, 86.42719, 11.77354, -0.7538634, 0, 0, -0.6570312,  True, '2019-02-10 00:00:00'); /* Silt Lurker */
/* @teleloc 0x974F0024 [118.631700 86.427190 11.773540] -0.753863 0.000000 0.000000 -0.657031 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7974F00B,  9256, 0x974F0020, 84.84323, 172.5217, 11.30854, 0.7168322, 0, 0, -0.6972457,  True, '2019-02-10 00:00:00'); /* Dune Reaver */
