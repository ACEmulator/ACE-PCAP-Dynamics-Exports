...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7C499004,   193, 0xC4990006, 8.738653, 131.5422, 6.470587, 0.9717975, 0, 0, -0.2358169,  True, '2019-02-10 00:00:00'); /* Drudge Slinker */
/* @teleloc 0xC4990006 [8.738653 131.542200 6.470587] 0.971798 0.000000 0.000000 -0.235817 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7C499005,  1614, 0xC4990006, 4.002723, 141.623, 8.941221, 0.5211483, 0, 0, -0.8534662,  True, '2019-02-10 00:00:00'); /* Jade Gromnie */
/* @teleloc 0xC4990006 [4.002723 141.623000 8.941221] 0.521148 0.000000 0.000000 -0.853466 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7C499006,   200, 0xC4990010, 34.4355, 187.6664, 6.27175, -0.4417812, 0, 0, -0.8971229,  True, '2019-02-10 00:00:00'); /* Mud Golem */
/* @teleloc 0xC4990010 [34.435500 187.666400 6.271750] -0.441781 0.000000 0.000000 -0.897123 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7C499007,  7989, 0xC499001F, 85.98723, 144.2758, 1.5518, 0.9605221, 0, 0, -0.2782038,  True, '2019-02-10 00:00:00'); /* Scavenger Ursuin */
/* @teleloc 0xC499001F [85.987230 144.275800 1.551800] 0.960522 0.000000 0.000000 -0.278204 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7C499008,   200, 0xC4990018, 53.69613, 190.2607, 3.536323, -0.4417812, 0, 0, -0.8971229,  True, '2019-02-10 00:00:00'); /* Mud Golem */
