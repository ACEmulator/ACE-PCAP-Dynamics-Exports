...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x74531003, 36829, 0x4531000C, 28.96876, 89.57384, 80.47378, -0.6224666, 0, 0, -0.7826464,  True, '2019-02-10 00:00:00'); /* Acidic Diamond Golem */
/* @teleloc 0x4531000C [28.968760 89.573840 80.473780] -0.622467 0.000000 0.000000 -0.782646 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x74531004,  7982, 0x4531003E, 187.2434, 132.5386, 6.394281, 0.7885727, 0, 0, -0.6149415,  True, '2019-02-10 00:00:00'); /* Destroyer Grievver */
