...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x79761003,  5705, 0x97610034, 156.4186, 88.76629, 10.36481, 0.992713, 0, 0, -0.120504,  True, '2019-02-10 00:00:00'); /* Flicker */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x79761006,   180, 0x97610030, 125.584, 173.5541, 14.00552, 0.796565, 0, 0, -0.604553,  True, '2019-02-10 00:00:00'); /* Sandy Armoredillo */
