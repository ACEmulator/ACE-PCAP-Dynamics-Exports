...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x79968005,  1605, 0x9968001C, 95.38018, 75.82793, 30.3783, -0.3721749, 0, 0, -0.9281626,  True, '2019-02-10 00:00:00'); /* Auroch Fire Yearling */
/* @teleloc 0x9968001C [95.380180 75.827930 30.378300] -0.372175 0.000000 0.000000 -0.928163 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x79968006,   202, 0x9968002B, 143.3279, 58.67721, 30.01, -0.06115794, 0, 0, -0.9981281,  True, '2019-02-10 00:00:00'); /* Sandstone Golem */
