...
VALUES (0x78655001,  1154, 0x8655000C, 32.2813, 77.14866, 13.57545, 0.17882, 0, 0, -0.983882, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78655002,  1611, 0x8655000C, 32.2813, 77.14866, 13.57545, 0.17882, 0, 0, -0.983882,  True, '2019-02-10 00:00:00'); /* Rust Gromnie */
/* @teleloc 0x8655000C [32.281300 77.148660 13.575450] 0.178820 0.000000 0.000000 -0.983882 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78655003,  1611, 0x86550004, 18.93444, 81.60654, 13.20395, 0.17882, 0, 0, -0.983882,  True, '2019-02-10 00:00:00'); /* Rust Gromnie */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78655007,   180, 0x8655003D, 168.363, 112.0871, 12.66143, 0.931436, 0, 0, -0.363905,  True, '2019-02-10 00:00:00'); /* Sandy Armoredillo */
/* @teleloc 0x8655003D [168.363000 112.087100 12.661430] 0.931436 0.000000 0.000000 -0.363905 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78655008,   950, 0x86550034, 149.8069, 74.12566, 10.97532, 0.931436, 0, 0, -0.363905,  True, '2019-02-10 00:00:00'); /* Zombie */
/* @teleloc 0x86550034 [149.806900 74.125660 10.975320] 0.931436 0.000000 0.000000 -0.363905 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78655009,   949, 0x86550034, 159.9824, 87.7825, 11.37878, 0.996679, 0, 0, -0.081427,  True, '2019-02-10 00:00:00'); /* Red Rat */
/* @teleloc 0x86550034 [159.982400 87.782500 11.378780] 0.996679 0.000000 0.000000 -0.081427 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7865500A,   192, 0x8655003C, 171.42, 94.19838, 13.08287, 0.173648, 0, 0, -0.984808,  True, '2019-02-10 00:00:00'); /* Drudge Prowler */
/* @teleloc 0x8655003C [171.420000 94.198380 13.082870] 0.173648 0.000000 0.000000 -0.984808 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7865500B,    16, 0x86550005, 17.00864, 107.9298, 12.0075, 0.17882, 0, 0, -0.983882,  True, '2019-02-10 00:00:00'); /* Undead */
