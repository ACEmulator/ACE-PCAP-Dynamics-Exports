...
VALUES (0x72F5A001,  1154, 0x2F5A000C, 28.91651, 90.43492, 0.01, -0.041796, 0, 0, -0.999126, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72F5A002, 36830, 0x2F5A000C, 28.91651, 90.43492, 0.01, -0.041796, 0, 0, -0.999126,  True, '2019-02-10 00:00:00'); /* Diamond Golem */
/* @teleloc 0x2F5A000C [28.916510 90.434920 0.010000] -0.041796 0.000000 0.000000 -0.999126 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72F5A003, 24497, 0x2F5A0009, 29.30505, 17.5573, 2.157566, 0.600729, 0, 0, -0.799453,  True, '2019-02-10 00:00:00'); /* Gotrok Tiatus */
/* @teleloc 0x2F5A0009 [29.305050 17.557300 2.157566] 0.600729 0.000000 0.000000 -0.799453 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72F5A004, 24497, 0x2F5A000D, 42.3965, 105.9907, 0.01, -0.087156, 0, 0, -0.996195,  True, '2019-02-10 00:00:00'); /* Gotrok Tiatus */
/* @teleloc 0x2F5A000D [42.396500 105.990700 0.010000] -0.087156 0.000000 0.000000 -0.996195 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72F5A005, 24494, 0x2F5A000D, 30.3965, 109.9907, 0.01, 0.258819, 0, 0, -0.965926,  True, '2019-02-10 00:00:00'); /* Gotrok Extas */
/* @teleloc 0x2F5A000D [30.396500 109.990700 0.010000] 0.258819 0.000000 0.000000 -0.965926 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72F5A006, 24494, 0x2F5A000D, 38.7965, 116.9907, 0.01, -0.766044, 0, 0, -0.642788,  True, '2019-02-10 00:00:00'); /* Gotrok Extas */
/* @teleloc 0x2F5A000D [38.796500 116.990700 0.010000] -0.766044 0.000000 0.000000 -0.642788 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72F5A007,  7126, 0x2F5A0005, 23.98018, 114.4449, 0.000001, -0.041796, 0, 0, -0.999126,  True, '2019-02-10 00:00:00'); /* Cursed Wisp */
/* @teleloc 0x2F5A0005 [23.980180 114.444900 0.000001] -0.041796 0.000000 0.000000 -0.999126 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72F5A008, 23616, 0x2F5A0001, 8.866693, 3.675914, 11.54861, 0.600729, 0, 0, -0.799453,  True, '2019-02-10 00:00:00'); /* Crystal Shard */
/* @teleloc 0x2F5A0001 [8.866693 3.675914 11.548610] 0.600729 0.000000 0.000000 -0.799453 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72F5A009, 36855, 0x2F5A0005, 6.510165, 107.4883, 0.0025, -0.041796, 0, 0, -0.999126,  True, '2019-02-10 00:00:00'); /* Armored Skeleton */
/* @teleloc 0x2F5A0005 [6.510165 107.488300 0.002500] -0.041796 0.000000 0.000000 -0.999126 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72F5A00A, 10807, 0x2F5A0001, 10.06306, 13.82098, 3.447822, 0.600729, 0, 0, -0.799453,  True, '2019-02-10 00:00:00'); /* Augmented Tumerok */
