...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7147100B, 36830, 0x1471000D, 36.95322, 111.7327, 110, 0.9238795, 0, 0, -0.3826835,  True, '2019-02-10 00:00:00'); /* Diamond Golem */
/* @teleloc 0x1471000D [36.953220 111.732700 110.000000] 0.923880 0.000000 0.000000 -0.382684 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7147100C,  8138, 0x1471001C, 82.2758, 94.7496, 85.72842, 0.9324065, 0, 0, -0.3614113,  True, '2019-02-10 00:00:00'); /* Extas Raider */
/* @teleloc 0x1471001C [82.275800 94.749600 85.728420] 0.932407 0.000000 0.000000 -0.361411 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7147100D, 11540, 0x14710025, 116.8465, 98.30767, 70.74377, 0.6619371, 0, 0, -0.7495594,  True, '2019-02-10 00:00:00'); /* Armored Tusker */
/* @teleloc 0x14710025 [116.846500 98.307670 70.743770] 0.661937 0.000000 0.000000 -0.749559 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7147100E, 23617, 0x1471001E, 86.40898, 135.8197, 99.15867, -0.4790812, 0, 0, -0.8777705,  True, '2019-02-10 00:00:00'); /* Tumerok Champion */
