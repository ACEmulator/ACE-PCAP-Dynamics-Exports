...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7B0C1001,  1154, 0xB0C1000B, 44.99887, 63.09117, 192.2422, -0.475423, 0, 0, -0.879758, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7B0C1002, 22010, 0xB0C1000B, 44.99887, 63.09117, 192.2422, -0.475423, 0, 0, -0.879758,  True, '2019-02-10 00:00:00'); /* Olthoi Servant */
/* @teleloc 0xB0C1000B [44.998870 63.091170 192.242200] -0.475423 0.000000 0.000000 -0.879758 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7B0C1003, 14521, 0xB0C10022, 119.8076, 46.79498, 184.1585, 0.678386, 0, 0, -0.734705,  True, '2019-02-10 00:00:00'); /* Glacial Golem */
/* @teleloc 0xB0C10022 [119.807600 46.794980 184.158500] 0.678386 0.000000 0.000000 -0.734705 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7B0C1004,   937, 0xB0C10014, 53.04108, 75.96095, 192.0071, 0.92388, 0, 0, -0.382684,  True, '2019-02-10 00:00:00'); /* Banderling Guard */
/* @teleloc 0xB0C10014 [53.041080 75.960950 192.007100] 0.923880 0.000000 0.000000 -0.382684 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7B0C1005,   937, 0xB0C1000C, 45.98909, 78.51427, 191.8396, 0.707107, 0, 0, -0.707107,  True, '2019-02-10 00:00:00'); /* Banderling Guard */
