...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73B1A006,  7119, 0x3B1A000A, 33.56686, 42.19684, 11.60098, 0.9888963, 0, 0, -0.1486071,  True, '2019-02-10 00:00:00'); /* Imperial Mu-miyah */
/* @teleloc 0x3B1A000A [33.566860 42.196840 11.600980] 0.988896 0.000000 0.000000 -0.148607 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73B1A007, 36855, 0x3B1A0003, 2.899374, 63.4573, 8.714391, -0.7715747, 0, 0, -0.6361388,  True, '2019-02-10 00:00:00'); /* Armored Skeleton */
