...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78270004, 10801, 0x8270000E, 34.8262, 140.8827, 12.20313, 0.6476766, 0, 0, -0.7619153,  True, '2019-02-10 00:00:00'); /* Shallow Rift */
/* @teleloc 0x8270000E [34.826200 140.882700 12.203130] 0.647677 0.000000 0.000000 -0.761915 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78270005,  1761, 0x8270000E, 28.734, 136.4181, 12.97618, 0.1504285, 0, 0, -0.9886209,  True, '2019-02-10 00:00:00'); /* Skeleton Captain */
/* @teleloc 0x8270000E [28.734000 136.418100 12.976180] 0.150429 0.000000 0.000000 -0.988621 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78270006,  2439, 0x82700020, 95.58722, 173.9622, 14.0055, 0.9857717, 0, 0, -0.1680895,  True, '2019-02-10 00:00:00'); /* Tumerok Fighter */
/* @teleloc 0x82700020 [95.587220 173.962200 14.005500] 0.985772 0.000000 0.000000 -0.168090 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78270007,  1611, 0x82700026, 119.8766, 140.8408, 14.0045, 0.9537169, 0, 0, -0.3007058,  True, '2019-02-10 00:00:00'); /* Rust Gromnie */
/* @teleloc 0x82700026 [119.876600 140.840800 14.004500] 0.953717 0.000000 0.000000 -0.300706 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78270008,  1542, 0x8270000E, 26.70024, 127.5793, 12.40659, 0.9238795, 0, 0, -0.3826835, False, '2019-02-10 00:00:00'); /* Linkable Item Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78270009,  4180, 0x8270000E, 26.70024, 127.5793, 12.40659, 0.9238795, 0, 0, -0.3826835,  True, '2019-02-10 00:00:00'); /* Corpse */
/* @teleloc 0x8270000E [26.700240 127.579300 12.406590] 0.923880 0.000000 0.000000 -0.382684 */
