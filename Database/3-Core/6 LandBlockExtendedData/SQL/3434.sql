...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7343400C, 24279, 0x34340005, 17.87544, 110.8961, 44.76198, 0.99054, 0, 0, -0.1372241,  True, '2019-02-10 00:00:00'); /* Gloom Drudge */
/* @teleloc 0x34340005 [17.875440 110.896100 44.761980] 0.990540 0.000000 0.000000 -0.137224 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7343400D, 11535, 0x34340005, 14.6551, 98.21306, 45.81558, 0.99054, 0, 0, -0.1372241,  True, '2019-02-10 00:00:00'); /* Chaos Wisp */
/* @teleloc 0x34340005 [14.655100 98.213060 45.815580] 0.990540 0.000000 0.000000 -0.137224 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7343400E, 11535, 0x34340018, 69.23809, 172.9484, 44.41237, 0.9624448, 0, 0, -0.2714774,  True, '2019-02-10 00:00:00'); /* Chaos Wisp */
/* @teleloc 0x34340018 [69.238090 172.948400 44.412370] 0.962445 0.000000 0.000000 -0.271477 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7343400F, 23478, 0x34340017, 70.20261, 164.3506, 44.00715, 0.9659258, 0, 0, -0.258819,  True, '2019-02-10 00:00:00'); /* Banderling Predator */
/* @teleloc 0x34340017 [70.202610 164.350600 44.007150] 0.965926 0.000000 0.000000 -0.258819 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73434010, 23479, 0x34340017, 64.15189, 162.8984, 44.00715, 0.8191521, 0, 0, -0.5735765,  True, '2019-02-10 00:00:00'); /* Banderling Scalper */
