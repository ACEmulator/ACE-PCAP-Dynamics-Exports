...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x788AD004,  7105, 0x88AD000C, 31.28501, 86.96304, 55.40491, 0.9988627, 0, 0, -0.04767864,  True, '2019-02-10 00:00:00'); /* White Phyntos Wasp */
/* @teleloc 0x88AD000C [31.285010 86.963040 55.404910] 0.998863 0.000000 0.000000 -0.047679 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x788AD005, 24288, 0x88AD0010, 29.01537, 173.9961, 66.90962, -0.08451624, 0, 0, -0.9964221,  True, '2019-02-10 00:00:00'); /* Cruel Monouga */
