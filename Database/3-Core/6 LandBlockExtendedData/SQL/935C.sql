...
VALUES (0x7935C001,  1154, 0x935C0003, 23.9808, 71.78996, 14.0105, -0.004478, 0, 0, -0.99999, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7935C002,    19, 0x935C0003, 23.9808, 71.78996, 14.0105, -0.004478, 0, 0, -0.99999,  True, '2019-02-10 00:00:00'); /* Bronze Armoredillo */
/* @teleloc 0x935C0003 [23.980800 71.789960 14.010500] -0.004478 0.000000 0.000000 -0.999990 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7935C003,  5682, 0x935C0013, 52.98413, 57.90415, 12.35181, -0.739334, 0, 0, -0.673339,  True, '2019-02-10 00:00:00'); /* Charred Skeleton */
/* @teleloc 0x935C0013 [52.984130 57.904150 12.351810] -0.739334 0.000000 0.000000 -0.673339 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7935C004,  1759, 0x935C000C, 31.96892, 76.59702, 12.67435, 0.707107, 0, 0, -0.707107,  True, '2019-02-10 00:00:00'); /* Skeleton */
/* @teleloc 0x935C000C [31.968920 76.597020 12.674350] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7935C005,  1759, 0x935C000C, 30.5694, 79.86066, 12.9076, 0.976296, 0, 0, -0.21644,  True, '2019-02-10 00:00:00'); /* Skeleton */
/* @teleloc 0x935C000C [30.569400 79.860660 12.907600] 0.976296 0.000000 0.000000 -0.216440 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7935C006,  1626, 0x935C0005, 16.25923, 105.2176, 13.1208, 0.177784, 0, 0, -0.98407,  True, '2019-02-10 00:00:00'); /* Silver Rat */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7935C009,  1763, 0x935C003B, 180.9679, 66.91089, 10.42959, 0.802311, 0, 0, -0.596907,  True, '2019-02-10 00:00:00'); /* Lesser Mu-miyah */
/* @teleloc 0x935C003B [180.967900 66.910890 10.429590] 0.802311 0.000000 0.000000 -0.596907 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7935C00A,  1632, 0x935C001B, 77.86086, 53.54159, 13.0799, 0.608607, 0, 0, -0.793472,  True, '2019-02-10 00:00:00'); /* Drudge Slave */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7935C00E, 27255, 0x935C0012, 48.10956, 39.09462, 14.02, -0.739334, 0, 0, -0.673339,  True, '2019-02-10 00:00:00'); /* Mud Golem Sludge Lord */
/* @teleloc 0x935C0012 [48.109560 39.094620 14.020000] -0.739334 0.000000 0.000000 -0.673339 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7935C00F,   180, 0x935C000C, 32.46527, 84.5501, 12.59962, -0.004478, 0, 0, -0.99999,  True, '2019-02-10 00:00:00'); /* Sandy Armoredillo */
/* @teleloc 0x935C000C [32.465270 84.550100 12.599620] -0.004478 0.000000 0.000000 -0.999990 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7935C010, 10801, 0x935C0030, 134.0435, 170.3936, 11.46745, -0.89886, 0, 0, -0.438236,  True, '2019-02-10 00:00:00'); /* Shallow Rift */
/* @teleloc 0x935C0030 [134.043500 170.393600 11.467450] -0.898860 0.000000 0.000000 -0.438236 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7935C011,   949, 0x935C000F, 36.96806, 151.4146, 10.62708, 0.296356, 0, 0, -0.955078,  True, '2019-02-10 00:00:00'); /* Red Rat */
/* @teleloc 0x935C000F [36.968060 151.414600 10.627080] 0.296356 0.000000 0.000000 -0.955078 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7935C012,   232, 0x935C0005, 17.27855, 102.3656, 13.47453, 0.258819, 0, 0, -0.965926,  True, '2019-02-10 00:00:00'); /* Tumerok Scout */
/* @teleloc 0x935C0005 [17.278550 102.365600 13.474530] 0.258819 0.000000 0.000000 -0.965926 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7935C013,  4249, 0x935C0004, 15.44041, 86.32564, 14.0044, 0.953717, 0, 0, -0.300706,  True, '2019-02-10 00:00:00'); /* Young Mosswart */
/* @teleloc 0x935C0004 [15.440410 86.325640 14.004400] 0.953717 0.000000 0.000000 -0.300706 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7935C014,  4249, 0x935C0004, 12.44041, 84.72564, 14.0044, 0.707107, 0, 0, -0.707107,  True, '2019-02-10 00:00:00'); /* Young Mosswart */
/* @teleloc 0x935C0004 [12.440410 84.725640 14.004400] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7935C015,  2439, 0x935C0005, 23.57648, 103.2235, 12.83687, 0.906308, 0, 0, -0.422618,  True, '2019-02-10 00:00:00'); /* Tumerok Fighter */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7935C019,  6117, 0x935C0004, 15.94041, 82.32564, 14.1, 0.999048, 0, 0, -0.043619,  True, '2019-02-10 00:00:00'); /* Pile of Long Sticks */
