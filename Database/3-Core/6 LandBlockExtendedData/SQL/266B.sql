...
VALUES (0x7266B001,  1154, 0x266B0030, 140.0217, 179.1545, 92.16919, -0.9547276, 0, 0, -0.2974815, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7266B003, 23482, 0x266B002E, 132.3033, 141.8544, 73.79406, 0.5061939, 0, 0, -0.8624197,  True, '2019-02-10 00:00:00'); /* Olthoi Warrior */
/* @teleloc 0x266B002E [132.303300 141.854400 73.794060] 0.506194 0.000000 0.000000 -0.862420 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7266B004,  7982, 0x266B0017, 51.96075, 147.545, 85.40952, 0.9063078, 0, 0, -0.4226183,  True, '2019-02-10 00:00:00'); /* Destroyer Grievver */
/* @teleloc 0x266B0017 [51.960750 147.545000 85.409520] 0.906308 0.000000 0.000000 -0.422618 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7266B005, 23563, 0x266B001D, 87.05653, 113.8386, 73.36095, 0.6376358, 0, 0, -0.7703379,  True, '2019-02-10 00:00:00'); /* Sinister Shadow */
/* @teleloc 0x266B001D [87.056530 113.838600 73.360950] 0.637636 0.000000 0.000000 -0.770338 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7266B006, 23616, 0x266B0032, 148.8191, 40.4201, 76.13301, -0.7694284, 0, 0, -0.638733,  True, '2019-02-10 00:00:00'); /* Crystal Shard */
