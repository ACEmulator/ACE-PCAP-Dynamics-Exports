...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x785C0005, 38177, 0x85C00023, 96.26576, 49.96552, 244.1884, -0.8444861, 0, 0, -0.5355775,  True, '2019-02-10 00:00:00'); /* Blighted Oak Golem */
/* @teleloc 0x85C00023 [96.265760 49.965520 244.188400] -0.844486 0.000000 0.000000 -0.535578 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x785C0006,   212, 0x85C0002C, 139.5474, 89.3448, 124.6552, 0.3571929, 0, 0, -0.9340307,  True, '2019-02-10 00:00:00'); /* Olthoi Noble */
