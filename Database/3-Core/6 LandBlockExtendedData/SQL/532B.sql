...
VALUES (0x7532B001,  1154, 0x532B000C, 46.34949, 78.91974, 0.285086, 0.173648, 0, 0, -0.984808, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7532B002, 36834, 0x532B000C, 46.34949, 78.91974, 0.285086, 0.173648, 0, 0, -0.984808,  True, '2019-02-10 00:00:00'); /* Vapor Golem */
/* @teleloc 0x532B000C [46.349490 78.919740 0.285086] 0.173648 0.000000 0.000000 -0.984808 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7532B003, 36834, 0x532B0014, 48.30402, 73.78751, -0.09, 0.92388, 0, 0, -0.382684,  True, '2019-02-10 00:00:00'); /* Vapor Golem */
/* @teleloc 0x532B0014 [48.304020 73.787510 -0.090000] 0.923880 0.000000 0.000000 -0.382684 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7532B004, 36834, 0x532B0006, 5.633976, 128.1443, 22.84552, 0.99859, 0, 0, -0.05308,  True, '2019-02-10 00:00:00'); /* Vapor Golem */
/* @teleloc 0x532B0006 [5.633976 128.144300 22.845520] 0.998590 0.000000 0.000000 -0.053080 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7532B005, 36855, 0x532B0020, 84.89122, 184.3552, -0.8975, -0.372622, 0, 0, -0.927983,  True, '2019-02-10 00:00:00'); /* Armored Skeleton */
/* @teleloc 0x532B0020 [84.891220 184.355200 -0.897500] -0.372622 0.000000 0.000000 -0.927983 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7532B006, 21549, 0x532B0014, 51.19156, 95.68031, -0.0935, 0.871813, 0, 0, -0.489838,  True, '2019-02-10 00:00:00'); /* Corrosion Wisp */
/* @teleloc 0x532B0014 [51.191560 95.680310 -0.093500] 0.871813 0.000000 0.000000 -0.489838 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7532B007, 23564, 0x532B0018, 57.19429, 188.1953, -0.095, -0.372622, 0, 0, -0.927983,  True, '2019-02-10 00:00:00'); /* Tenebrous Shadow */
