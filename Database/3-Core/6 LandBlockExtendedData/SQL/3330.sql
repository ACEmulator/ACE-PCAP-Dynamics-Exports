...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73330003, 23480, 0x33300001, 15.56058, 17.28018, 132.0045, -0.8869116, 0, 0, -0.4619392,  True, '2019-02-10 00:00:00'); /* Drudge Bloodletter */
/* @teleloc 0x33300001 [15.560580 17.280180 132.004500] -0.886912 0.000000 0.000000 -0.461939 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73330004, 36853, 0x33300011, 58.04445, 4.243783, 128.7985, 0.7071068, 0, 0, -0.7071068,  True, '2019-02-10 00:00:00'); /* Tenebrous Shadow */
/* @teleloc 0x33300011 [58.044450 4.243783 128.798500] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73330005, 14520, 0x33300003, 5.274374, 48.62118, 132.01, -0.8869116, 0, 0, -0.4619392,  True, '2019-02-10 00:00:00'); /* Pyreal Golem */
/* @teleloc 0x33300003 [5.274374 48.621180 132.010000] -0.886912 0.000000 0.000000 -0.461939 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73330006, 36845, 0x33300011, 61.85752, 6.610739, 118.4723, 0.8870109, 0, 0, -0.4617486,  True, '2019-02-10 00:00:00'); /* Abyssal Shadow */
/* @teleloc 0x33300011 [61.857520 6.610739 118.472300] 0.887011 0.000000 0.000000 -0.461749 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73330007, 36851, 0x33300011, 55.2808, 6.234282, 122.2774, 0.7071068, 0, 0, -0.7071068,  True, '2019-02-10 00:00:00'); /* Sinister Shadow */
/* @teleloc 0x33300011 [55.280800 6.234282 122.277400] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73330008,  7125, 0x3330000A, 45.646, 34.10782, 128.3923, -0.9791989, 0, 0, -0.2029029,  True, '2019-02-10 00:00:00'); /* Affliction Wisp */
