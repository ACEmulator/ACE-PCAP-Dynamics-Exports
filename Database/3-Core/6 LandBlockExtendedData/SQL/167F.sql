...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7167F006, 23563, 0x167F0001, 5.951477, 8.426793, 150.005, -0.8758543, 0, 0, -0.4825757,  True, '2019-02-10 00:00:00'); /* Sinister Shadow */
/* @teleloc 0x167F0001 [5.951477 8.426793 150.005000] -0.875854 0.000000 0.000000 -0.482576 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7167F007, 28553, 0x167F002C, 143.8721, 95.52576, 149.913, -0.8813859, 0, 0, -0.472397,  True, '2019-02-10 00:00:00'); /* Rufous Grievver */
/* @teleloc 0x167F002C [143.872100 95.525760 149.913000] -0.881386 0.000000 0.000000 -0.472397 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7167F008, 23616, 0x167F002A, 130.3667, 32.54933, 144.3004, 0.3595431, 0, 0, -0.9331285,  True, '2019-02-10 00:00:00'); /* Crystal Shard */
