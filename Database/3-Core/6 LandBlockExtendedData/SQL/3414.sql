...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7341400B,  7340, 0x3414001C, 74.06667, 74.20514, 50.06361, 0.8191521, 0, 0, -0.5735765,  True, '2019-02-10 00:00:00'); /* Virindi Observer */
/* @teleloc 0x3414001C [74.066670 74.205140 50.063610] 0.819152 0.000000 0.000000 -0.573577 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7341400C, 36829, 0x34140014, 62.7969, 76.14394, 51.04598, -0.04413296, 0, 0, -0.9990256,  True, '2019-02-10 00:00:00'); /* Acidic Diamond Golem */
/* @teleloc 0x34140014 [62.796900 76.143940 51.045980] -0.044133 0.000000 0.000000 -0.999026 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7341400D,  5497, 0x34140014, 69.38082, 78.29938, 51.60384, 0.9659258, 0, 0, -0.258819,  True, '2019-02-10 00:00:00'); /* Virindi Director */
/* @teleloc 0x34140014 [69.380820 78.299380 51.603840] 0.965926 0.000000 0.000000 -0.258819 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7341400E,  8431, 0x34140031, 162.0928, 18.98196, 10.0065, 0.02549594, 0, 0, -0.9996749,  True, '2019-02-10 00:00:00'); /* Nomad Mu-miyah */
/* @teleloc 0x34140031 [162.092800 18.981960 10.006500] 0.025496 0.000000 0.000000 -0.999675 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7341400F, 36855, 0x34140004, 20.94915, 80.84339, 52.21335, -0.04413296, 0, 0, -0.9990256,  True, '2019-02-10 00:00:00'); /* Armored Skeleton */
/* @teleloc 0x34140004 [20.949150 80.843390 52.213350] -0.044133 0.000000 0.000000 -0.999026 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73414010, 24134, 0x34140008, 1.497803, 189.6695, 56.87602, -0.3477374, 0, 0, -0.937592,  True, '2019-02-10 00:00:00'); /* Reedshark Slasher */
