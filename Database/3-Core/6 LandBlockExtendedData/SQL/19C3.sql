...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x719C3007, 27717, 0x19C3001C, 75.59079, 89.55843, 50.5681, 0.9961947, 0, 0, -0.08715574,  True, '2019-02-10 00:00:00'); /* Ursuin Slicer */
/* @teleloc 0x19C3001C [75.590790 89.558430 50.568100] 0.996195 0.000000 0.000000 -0.087156 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x719C3008, 27717, 0x19C3001C, 80.38263, 91.62923, 49.54271, 0.8191521, 0, 0, -0.5735765,  True, '2019-02-10 00:00:00'); /* Ursuin Slicer */
/* @teleloc 0x19C3001C [80.382630 91.629230 49.542710] 0.819152 0.000000 0.000000 -0.573577 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x719C3009, 27710, 0x19C30002, 20.8217, 35.59218, 62.14436, -0.9993292, 0, 0, -0.03662188,  True, '2019-02-10 00:00:00'); /* Brass Gromnie */
/* @teleloc 0x19C30002 [20.821700 35.592180 62.144360] -0.999329 0.000000 0.000000 -0.036622 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x719C300A, 27711, 0x19C30031, 167.798, 22.20546, 56.003, -0.1814734, 0, 0, -0.9833959,  True, '2019-02-10 00:00:00'); /* Copper Gromnie */
/* @teleloc 0x19C30031 [167.798000 22.205460 56.003000] -0.181473 0.000000 0.000000 -0.983396 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x719C300B, 27712, 0x19C30014, 68.46906, 82.59208, 51.16492, 0.3426015, 0, 0, -0.9394808,  True, '2019-02-10 00:00:00'); /* Badlands Siraluun */
