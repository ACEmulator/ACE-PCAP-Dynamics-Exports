...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72A7E009, 20189, 0x2A7E001A, 86.923, 34.47335, 191.5331, -0.1504782, 0, 0, -0.9886133,  True, '2019-02-10 00:00:00'); /* Brumal */
/* @teleloc 0x2A7E001A [86.923000 34.473350 191.533100] -0.150478 0.000000 0.000000 -0.988613 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72A7E00A, 20191, 0x2A7E001A, 82.82301, 32.23556, 192.9439, -0.1504782, 0, 0, -0.9886133,  True, '2019-02-10 00:00:00'); /* Horripal */
/* @teleloc 0x2A7E001A [82.823010 32.235560 192.943900] -0.150478 0.000000 0.000000 -0.988613 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72A7E00B, 23616, 0x2A7E0019, 84.52374, 7.791212, 208.1917, -0.385599, 0, 0, -0.9226665,  True, '2019-02-10 00:00:00'); /* Crystal Shard */
/* @teleloc 0x2A7E0019 [84.523740 7.791212 208.191700] -0.385599 0.000000 0.000000 -0.922667 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72A7E00C, 24281, 0x2A7E0012, 59.34723, 41.56231, 183.3322, -0.1504782, 0, 0, -0.9886133,  True, '2019-02-10 00:00:00'); /* Drudge Mystic */
/* @teleloc 0x2A7E0012 [59.347230 41.562310 183.332200] -0.150478 0.000000 0.000000 -0.988613 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72A7E00D, 24280, 0x2A7E0011, 69.16834, 11.42285, 203.8212, -0.385599, 0, 0, -0.9226665,  True, '2019-02-10 00:00:00'); /* Murk Drudge */
