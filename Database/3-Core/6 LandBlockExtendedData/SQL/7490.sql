...
VALUES (0x77490001,  1154, 0x74900030, 124.5709, 173.1662, 60.54744, 0.906308, 0, 0, -0.422618, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x77490002,  7978, 0x74900030, 124.5709, 173.1662, 60.54744, 0.906308, 0, 0, -0.422618,  True, '2019-02-10 00:00:00'); /* Scrawed Grievver */
/* @teleloc 0x74900030 [124.570900 173.166200 60.547440] 0.906308 0.000000 0.000000 -0.422618 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x77490003,  1757, 0x74900001, 19.37063, 2.821022, 89.01208, 0.92388, 0, 0, -0.382684,  True, '2019-02-10 00:00:00'); /* Shadow Lieutenant */
/* @teleloc 0x74900001 [19.370630 2.821022 89.012080] 0.923880 0.000000 0.000000 -0.382684 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x77490004,  1757, 0x74900001, 20.97063, 0.421022, 89.01208, 0.887011, 0, 0, -0.461749,  True, '2019-02-10 00:00:00'); /* Shadow Lieutenant */
/* @teleloc 0x74900001 [20.970630 0.421022 89.012080] 0.887011 0.000000 0.000000 -0.461749 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x77490005, 28877, 0x74900028, 101.548, 178.0884, 61.54017, -0.047413, 0, 0, -0.998875,  True, '2019-02-10 00:00:00'); /* Nasty Scarecrow */
/* @teleloc 0x74900028 [101.548000 178.088400 61.540170] -0.047413 0.000000 0.000000 -0.998875 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x77490006,   235, 0x74900008, 5.185928, 180.0362, 76.71561, -0.972066, 0, 0, -0.23471,  True, '2019-02-10 00:00:00'); /* Goldenback Tusker */
/* @teleloc 0x74900008 [5.185928 180.036200 76.715610] -0.972066 0.000000 0.000000 -0.234710 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x77490007, 11528, 0x74900007, 8.437723, 164.0648, 76.55643, -0.972066, 0, 0, -0.23471,  True, '2019-02-10 00:00:00'); /* Elaniwood Golem */
