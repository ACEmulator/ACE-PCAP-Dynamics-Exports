...
VALUES (0x7914C001,  1154, 0x914C000E, 41.74779, 138.9996, 15.96528, 0.8979, 0, 0, -0.440199, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7914C002,  9257, 0x914C000E, 41.74779, 138.9996, 15.96528, 0.8979, 0, 0, -0.440199,  True, '2019-02-10 00:00:00'); /* Silt Lurker */
/* @teleloc 0x914C000E [41.747790 138.999600 15.965280] 0.897900 0.000000 0.000000 -0.440199 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7914C003,  1762, 0x914C003F, 189.7919, 162.2951, 14.0025, 0.707107, 0, 0, -0.707107,  True, '2019-02-10 00:00:00'); /* Skeleton Lord */
/* @teleloc 0x914C003F [189.791900 162.295100 14.002500] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7914C004,  9256, 0x914C0015, 68.95538, 97.86784, 16.15765, 0.272754, 0, 0, -0.962084,  True, '2019-02-10 00:00:00'); /* Dune Reaver */
/* @teleloc 0x914C0015 [68.955380 97.867840 16.157650] 0.272754 0.000000 0.000000 -0.962084 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7914C005,  1615, 0x914C003C, 173.6591, 80.72043, 12.005, 0.953717, 0, 0, -0.300706,  True, '2019-02-10 00:00:00'); /* Ash Gromnie */
/* @teleloc 0x914C003C [173.659100 80.720430 12.005000] 0.953717 0.000000 0.000000 -0.300706 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7914C006,  1615, 0x914C003C, 176.7695, 83.88985, 12.005, 0.707107, 0, 0, -0.707107,  True, '2019-02-10 00:00:00'); /* Ash Gromnie */
/* @teleloc 0x914C003C [176.769500 83.889850 12.005000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7914C007,  8673, 0x914C0022, 98.66206, 31.56175, 15.59994, -0.9926, 0, 0, -0.121431,  True, '2019-02-10 00:00:00'); /* Risen Knight */
/* @teleloc 0x914C0022 [98.662060 31.561750 15.599940] -0.992600 0.000000 0.000000 -0.121431 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7914C008,   233, 0x914C0021, 108.1488, 6.039981, 16.53364, 0.92388, 0, 0, -0.382684,  True, '2019-02-10 00:00:00'); /* Tumerok Warrior */
/* @teleloc 0x914C0021 [108.148800 6.039981 16.533640] 0.923880 0.000000 0.000000 -0.382684 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7914C009,   231, 0x914C0021, 106.7857, 10.97982, 16.71811, 0.866025, 0, 0, -0.5,  True, '2019-02-10 00:00:00'); /* Tumerok Priest */
