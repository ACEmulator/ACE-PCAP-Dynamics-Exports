...
VALUES (0x72359001,  1154, 0x2359001B, 94.05729, 64.62834, 0.0025, 0.337764, 0, 0, -0.941231, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72359002, 12026, 0x2359001B, 94.05729, 64.62834, 0.0025, 0.337764, 0, 0, -0.941231,  True, '2019-02-10 00:00:00'); /* Dark Myrmidon */
/* @teleloc 0x2359001B [94.057290 64.628340 0.002500] 0.337764 0.000000 0.000000 -0.941231 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72359003,  7179, 0x2359001B, 90.26418, 59.04306, 0.0025, 0.337764, 0, 0, -0.941231,  True, '2019-02-10 00:00:00'); /* Relic Bones */
/* @teleloc 0x2359001B [90.264180 59.043060 0.002500] 0.337764 0.000000 0.000000 -0.941231 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72359004,  7179, 0x23590023, 98.1208, 59.99752, 0.0025, 0.337764, 0, 0, -0.941231,  True, '2019-02-10 00:00:00'); /* Relic Bones */
/* @teleloc 0x23590023 [98.120800 59.997520 0.002500] 0.337764 0.000000 0.000000 -0.941231 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72359005,  9264, 0x23590022, 109.5618, 40.77511, 0.631074, -0.15679, 0, 0, -0.987632,  True, '2019-02-10 00:00:00'); /* Virindi Executor */
/* @teleloc 0x23590022 [109.561800 40.775110 0.631074] -0.156790 0.000000 0.000000 -0.987632 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72359006,  9264, 0x23590035, 158.7894, 102.5027, 0.029, 0.819152, 0, 0, -0.573577,  True, '2019-02-10 00:00:00'); /* Virindi Executor */
/* @teleloc 0x23590035 [158.789400 102.502700 0.029000] 0.819152 0.000000 0.000000 -0.573577 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72359007, 24319, 0x23590022, 104.4583, 44.89638, 0.266885, -0.15679, 0, 0, -0.987632,  True, '2019-02-10 00:00:00'); /* Dark Master */
/* @teleloc 0x23590022 [104.458300 44.896380 0.266885] -0.156790 0.000000 0.000000 -0.987632 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72359008, 36829, 0x2359002C, 121.0163, 82.93683, 0.01, 0.337764, 0, 0, -0.941231,  True, '2019-02-10 00:00:00'); /* Acidic Diamond Golem */
/* @teleloc 0x2359002C [121.016300 82.936830 0.010000] 0.337764 0.000000 0.000000 -0.941231 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72359009, 36855, 0x23590035, 155.0961, 101.0455, 0.0025, 0.965322, 0, 0, -0.261064,  True, '2019-02-10 00:00:00'); /* Armored Skeleton */
