...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7371100D,  9264, 0x37110009, 36.39527, 8.298098, 45.7448, 0.8191521, 0, 0, -0.5735765,  True, '2019-02-10 00:00:00'); /* Virindi Executor */
/* @teleloc 0x37110009 [36.395270 8.298098 45.744800] 0.819152 0.000000 0.000000 -0.573577 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7371100E, 23563, 0x3711000C, 42.87937, 93.54855, 36.66853, 0.6884355, 0, 0, -0.7252976,  True, '2019-02-10 00:00:00'); /* Sinister Shadow */
/* @teleloc 0x3711000C [42.879370 93.548550 36.668530] 0.688436 0.000000 0.000000 -0.725298 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7371100F, 24134, 0x37110012, 54.27159, 24.12134, 45.57019, 0.9892942, 0, 0, -0.145935,  True, '2019-02-10 00:00:00'); /* Reedshark Slasher */
/* @teleloc 0x37110012 [54.271590 24.121340 45.570190] 0.989294 0.000000 0.000000 -0.145935 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73711010, 21551, 0x37110007, 6.094507, 146.5457, 10.0065, 0.9133175, 0, 0, -0.4072483,  True, '2019-02-10 00:00:00'); /* Strife Wisp */
/* @teleloc 0x37110007 [6.094507 146.545700 10.006500] 0.913318 0.000000 0.000000 -0.407248 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73711011, 23564, 0x3711001B, 76.37311, 53.4175, 51.09828, -0.9717609, 0, 0, -0.2359676,  True, '2019-02-10 00:00:00'); /* Tenebrous Shadow */
