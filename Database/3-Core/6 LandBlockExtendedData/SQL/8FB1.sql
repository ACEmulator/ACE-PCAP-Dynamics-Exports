...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78FB1004,  7105, 0x8FB10007, 1.482695, 162.3438, 48.012, 0.8204759, 0, 0, -0.5716811,  True, '2019-02-10 00:00:00'); /* White Phyntos Wasp */
/* @teleloc 0x8FB10007 [1.482695 162.343800 48.012000] 0.820476 0.000000 0.000000 -0.571681 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78FB1005,  7105, 0x8FB10007, 1.923599, 159.0248, 48.012, 0.8204759, 0, 0, -0.5716811,  True, '2019-02-10 00:00:00'); /* White Phyntos Wasp */
/* @teleloc 0x8FB10007 [1.923599 159.024800 48.012000] 0.820476 0.000000 0.000000 -0.571681 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78FB1006,  7096, 0x8FB10032, 167.3036, 47.80523, 55.81967, 0.9676487, 0, 0, -0.2523014,  True, '2019-02-10 00:00:00'); /* Gold Golem */
/* @teleloc 0x8FB10032 [167.303600 47.805230 55.819670] 0.967649 0.000000 0.000000 -0.252301 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78FB1007, 24294, 0x8FB1001B, 83.8646, 69.86111, 47.8925, 0.5646341, 0, 0, -0.8253413,  True, '2019-02-10 00:00:00'); /* Unruly Monouga */
/* @teleloc 0x8FB1001B [83.864600 69.861110 47.892500] 0.564634 0.000000 0.000000 -0.825341 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78FB1008,  7085, 0x8FB10006, 0.22789, 126.5461, 48.00715, 0.6473145, 0, 0, -0.7622231,  True, '2019-02-10 00:00:00'); /* Banderling Berserker */
