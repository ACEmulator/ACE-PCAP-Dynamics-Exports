...
VALUES (0x7C6A2001,  1154, 0xC6A2001E, 85.07456, 133.6502, 47.22317, -0.7280332, 0, 0, -0.6855418, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7C6A2003, 36443, 0xC6A20006, 0.708252, 142.4058, 32.06552, 0.8189635, 0, 0, -0.5738457,  True, '2019-02-10 00:00:00'); /* Harvest Reaper */
/* @teleloc 0xC6A20006 [0.708252 142.405800 32.065520] 0.818964 0.000000 0.000000 -0.573846 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7C6A2004,   195, 0xC6A2001D, 82.56596, 107.6655, 51.68036, 0.9978784, 0, 0, -0.06510483,  True, '2019-02-10 00:00:00'); /* Granite Golem */
/* @teleloc 0xC6A2001D [82.565960 107.665500 51.680360] 0.997878 0.000000 0.000000 -0.065105 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7C6A2005, 22809, 0xC6A20025, 101.8225, 114.0975, 53.96132, 0.3663034, 0, 0, -0.9304954,  True, '2019-02-10 00:00:00'); /* Banderling Bandit */
/* @teleloc 0xC6A20025 [101.822500 114.097500 53.961320] 0.366303 0.000000 0.000000 -0.930495 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7C6A2006,  8427, 0xC6A20025, 108.0771, 100.9237, 58.97796, 0.1965194, 0, 0, -0.9804999,  True, '2019-02-10 00:00:00'); /* Mosswart Fanatic */
