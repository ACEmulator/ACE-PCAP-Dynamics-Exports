...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7977C03A,  1542, 0x977C0004, 10.2763, 85.6773, 5.143642, 0.382683, 0, 0, -0.92388, False, '2019-02-10 00:00:00'); /* Linkable Item Generator */
/* @teleloc 0x977C0004 [10.276300 85.677300 5.143642] 0.382683 0.000000 0.000000 -0.923880 */

INSERT INTO `landblock_instance_link` (`parent_GUID`, `child_GUID`, `last_Modified`)
VALUES (0x7977C03A, 0x7977C03B, '2019-02-10 00:00:00') /* Samsur (1109) */;

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7977C03B,  1109, 0x977C0004, 10.2763, 85.6773, 5.143642, 0.382683, 0, 0, -0.92388,  True, '2019-02-10 00:00:00'); /* Samsur */
/* @teleloc 0x977C0004 [10.276300 85.677300 5.143642] 0.382683 0.000000 0.000000 -0.923880 */
