...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x71566005, 14877, 0x15660016, 60.38151, 123.4488, 36.68781, 0.777178, 0, 0, -0.6292809,  True, '2019-02-10 00:00:00'); /* Tsuric */
/* @teleloc 0x15660016 [60.381510 123.448800 36.687810] 0.777178 0.000000 0.000000 -0.629281 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x71566006, 36820, 0x1566000F, 31.61637, 163.3689, 37.75838, -0.5526366, 0, 0, -0.8334224,  True, '2019-02-10 00:00:00'); /* Banderling Scalper */
/* @teleloc 0x1566000F [31.616370 163.368900 37.758380] -0.552637 0.000000 0.000000 -0.833422 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x71566007, 36819, 0x15660015, 66.11693, 119.2307, 36.56151, -0.1707754, 0, 0, -0.98531,  True, '2019-02-10 00:00:00'); /* Banderling Savage */
/* @teleloc 0x15660015 [66.116930 119.230700 36.561510] -0.170775 0.000000 0.000000 -0.985310 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x71566008,  7097, 0x1566001F, 93.66763, 165.1537, 32.20436, -0.126042, 0, 0, -0.9920249,  True, '2019-02-10 00:00:00'); /* Platinum Golem */
/* @teleloc 0x1566001F [93.667630 165.153700 32.204360] -0.126042 0.000000 0.000000 -0.992025 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x71566009, 14520, 0x15660020, 95.81012, 170.6999, 32.01, -0.126042, 0, 0, -0.9920249,  True, '2019-02-10 00:00:00'); /* Pyreal Golem */
/* @teleloc 0x15660020 [95.810120 170.699900 32.010000] -0.126042 0.000000 0.000000 -0.992025 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7156600A, 14520, 0x15660028, 100.0014, 178.6471, 32.01, -0.126042, 0, 0, -0.9920249,  True, '2019-02-10 00:00:00'); /* Pyreal Golem */
/* @teleloc 0x15660028 [100.001400 178.647100 32.010000] -0.126042 0.000000 0.000000 -0.992025 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7156600B,  7127, 0x1566002F, 139.5274, 149.6818, 39.18947, 0.6252393, 0, 0, -0.7804331,  True, '2019-02-10 00:00:00'); /* Nightmare Wisp */
