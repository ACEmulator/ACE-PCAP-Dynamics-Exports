...
VALUES (0x7164C001,  1154, 0x164C0009, 32.53123, 15.68041, 2.69785, -0.999943, 0, 0, -0.01067991, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7164C003, 36823, 0x164C0011, 55.47942, 3.851176, 4.306903, -0.9400447, 0, 0, -0.3410513,  True, '2019-02-10 00:00:00'); /* Drudge Cabalist */
/* @teleloc 0x164C0011 [55.479420 3.851176 4.306903] -0.940045 0.000000 0.000000 -0.341051 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7164C004, 36821, 0x164C0007, 23.41763, 163.7162, 13.86264, 0.7071068, 0, 0, -0.7071068,  True, '2019-02-10 00:00:00'); /* Ascendant Drudge */
/* @teleloc 0x164C0007 [23.417630 163.716200 13.862640] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7164C005, 36825, 0x164C0018, 65.48521, 189.7078, 26.85845, 0.7330204, 0, 0, -0.6802067,  True, '2019-02-10 00:00:00'); /* Peerless Drudge */
/* @teleloc 0x164C0018 [65.485210 189.707800 26.858450] 0.733020 0.000000 0.000000 -0.680207 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7164C006, 36836, 0x164C0010, 43.8251, 176.0691, 20.04454, 0.7071068, 0, 0, -0.7071068,  True, '2019-02-10 00:00:00'); /* Raider Juggernaut */
/* @teleloc 0x164C0010 [43.825100 176.069100 20.044540] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7164C007, 36836, 0x164C0010, 38.29689, 174.0594, 19.03969, -4.371139E-08, 0, 0, -1,  True, '2019-02-10 00:00:00'); /* Raider Juggernaut */
/* @teleloc 0x164C0010 [38.296890 174.059400 19.039690] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7164C008,  1542, 0x164C0010, 41.35855, 176.1963, 20.1677, -4.371139E-08, 0, 0, -1, False, '2019-02-10 00:00:00'); /* Linkable Item Generator */
