...
INSERT INTO `landblock_instance_link` (`parent_GUID`, `child_GUID`, `last_Modified`)
VALUES (0x7BC5D003, 0x7BC5D004, '2019-02-10 00:00:00') /* Dark Falatacot Token of the Aura of Specialization Mastery (43522) */
     , (0x7BC5D003, 0x7BC5D005, '2019-02-10 00:00:00') /* Dark Falatacot Token of the Aura of Destruction (43436) */;
