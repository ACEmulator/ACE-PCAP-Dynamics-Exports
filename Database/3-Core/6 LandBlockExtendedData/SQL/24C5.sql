...
VALUES (0x724C5001,  1154, 0x24C50029, 138.7282, 21.88291, 46.53571, 0.4562418, 0, 0, -0.8898559, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x724C5003, 36112, 0x24C5000B, 38.11825, 71.25903, 51.90095, 0.6889463, 0, 0, -0.7248124,  True, '2019-02-10 00:00:00'); /* Aun Herbalist */
