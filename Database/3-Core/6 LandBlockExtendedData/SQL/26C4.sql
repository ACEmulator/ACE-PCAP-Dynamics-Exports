...
VALUES (0x726C4001,  1154, 0x26C40021, 97.89582, 13.13585, 26.74996, 0.962805, 0, 0, -0.2701971, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x726C4003, 11506, 0x26C4000B, 26.71481, 50.43082, 31.3263, 0.01681983, 0, 0, -0.9998586,  True, '2019-02-10 00:00:00'); /* Zharalim */
/* @teleloc 0x26C4000B [26.714810 50.430820 31.326300] 0.016820 0.000000 0.000000 -0.999859 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x726C4004, 27717, 0x26C4002B, 129.1733, 70.9423, 23.23816, 0.8191521, 0, 0, -0.5735765,  True, '2019-02-10 00:00:00'); /* Ursuin Slicer */
/* @teleloc 0x26C4002B [129.173300 70.942300 23.238160] 0.819152 0.000000 0.000000 -0.573577 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x726C4005, 27717, 0x26C4002C, 130.2447, 76.05132, 23.14887, 0.9961947, 0, 0, -0.08715574,  True, '2019-02-10 00:00:00'); /* Ursuin Slicer */
/* @teleloc 0x26C4002C [130.244700 76.051320 23.148870] 0.996195 0.000000 0.000000 -0.087156 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x726C4006, 24958, 0x26C40020, 80.21055, 178.2616, 23.13967, 0.9035756, 0, 0, -0.4284286,  True, '2019-02-10 00:00:00'); /* Olthoi Lancer */
/* @teleloc 0x26C40020 [80.210550 178.261600 23.139670] 0.903576 0.000000 0.000000 -0.428429 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x726C4007, 23482, 0x26C40020, 79.70854, 180.1304, 22.98914, 0.9035756, 0, 0, -0.4284286,  True, '2019-02-10 00:00:00'); /* Olthoi Warrior */
/* @teleloc 0x26C40020 [79.708540 180.130400 22.989140] 0.903576 0.000000 0.000000 -0.428429 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x726C4008, 23482, 0x26C40018, 69.23766, 169.0007, 24.06341, 0.9035756, 0, 0, -0.4284286,  True, '2019-02-10 00:00:00'); /* Olthoi Warrior */
