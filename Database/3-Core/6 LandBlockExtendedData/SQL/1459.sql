...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x71459006, 36819, 0x14590009, 46.93811, 1.919825, 0.007149994, -0.9257079, 0, 0, -0.3782391,  True, '2019-02-10 00:00:00'); /* Banderling Savage */
/* @teleloc 0x14590009 [46.938110 1.919825 0.007150] -0.925708 0.000000 0.000000 -0.378239 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x71459007, 36820, 0x14590022, 111.8673, 28.02636, 12.151, 0.9557219, 0, 0, -0.2942713,  True, '2019-02-10 00:00:00'); /* Banderling Scalper */
/* @teleloc 0x14590022 [111.867300 28.026360 12.151000] 0.955722 0.000000 0.000000 -0.294271 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x71459008,  7983, 0x14590031, 163.8958, 19.27833, 22.05237, 0.06367077, 0, 0, -0.9979709,  True, '2019-02-10 00:00:00'); /* Bane Grievver */
/* @teleloc 0x14590031 [163.895800 19.278330 22.052370] 0.063671 0.000000 0.000000 -0.997971 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x71459009, 36821, 0x14590003, 14.59446, 71.14996, 5.008244, 0.7071068, 0, 0, -0.7071068,  True, '2019-02-10 00:00:00'); /* Ascendant Drudge */
/* @teleloc 0x14590003 [14.594460 71.149960 5.008244] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7145900A, 36818, 0x14590011, 48.59309, 19.74846, 0.007149994, -0.9257079, 0, 0, -0.3782391,  True, '2019-02-10 00:00:00'); /* Banderling Predator */
