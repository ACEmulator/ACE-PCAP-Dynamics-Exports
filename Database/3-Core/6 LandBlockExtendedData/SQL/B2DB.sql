...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7B2DB006, 14800, 0xB2DB000B, 46.37116, 50.85589, 29.77201, -0.4474745, 0, 0, -0.8942967,  True, '2019-02-10 00:00:00'); /* Crystal Golem */
/* @teleloc 0xB2DB000B [46.371160 50.855890 29.772010] -0.447475 0.000000 0.000000 -0.894297 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7B2DB007,  7124, 0xB2DB000D, 40.42104, 114.9466, 23.0602, 0.9783671, 0, 0, -0.206876,  True, '2019-02-10 00:00:00'); /* Dark Magus */
/* @teleloc 0xB2DB000D [40.421040 114.946600 23.060200] 0.978367 0.000000 0.000000 -0.206876 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7B2DB008,  1757, 0xB2DB0029, 125.5368, 12.43835, 22.58013, 0.7282344, 0, 0, -0.6853282,  True, '2019-02-10 00:00:00'); /* Shadow Lieutenant */
