...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78FEE003,  9253, 0x8FEE000C, 41.93832, 92.31708, 7.68409, 0.8371094, 0, 0, -0.5470354,  True, '2019-02-10 00:00:00'); /* Wily Monouga */
/* @teleloc 0x8FEE000C [41.938320 92.317080 7.684090] 0.837109 0.000000 0.000000 -0.547035 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78FEE004,  1610, 0x8FEE002B, 120.8435, 63.24711, 3.275142, 0.9727376, 0, 0, -0.2319085,  True, '2019-02-10 00:00:00'); /* Drudge Ravener */
/* @teleloc 0x8FEE002B [120.843500 63.247110 3.275142] 0.972738 0.000000 0.000000 -0.231909 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78FEE005, 38177, 0x8FEE003B, 189.6585, 62.93977, 2.01, -0.7457224, 0, 0, -0.6662568,  True, '2019-02-10 00:00:00'); /* Blighted Oak Golem */
/* @teleloc 0x8FEE003B [189.658500 62.939770 2.010000] -0.745722 0.000000 0.000000 -0.666257 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78FEE006,  1629, 0x8FEE003C, 176.4187, 85.49314, 2.011, 0.03491176, 0, 0, -0.9993904,  True, '2019-02-10 00:00:00'); /* Tusker Guard */
/* @teleloc 0x8FEE003C [176.418700 85.493140 2.011000] 0.034912 0.000000 0.000000 -0.999390 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78FEE007,  1610, 0x8FEE003C, 180.2883, 85.81268, 2.00455, 0.8433914, 0, 0, -0.5372996,  True, '2019-02-10 00:00:00'); /* Drudge Ravener */
