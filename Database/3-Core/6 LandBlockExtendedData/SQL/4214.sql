...
VALUES (0x74214001,  1154, 0x4214003C, 175.1488, 76.05062, -0.871, -0.999682, 0, 0, -0.025207, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x74214002,  9264, 0x4214003C, 175.1488, 76.05062, -0.871, -0.999682, 0, 0, -0.025207,  True, '2019-02-10 00:00:00'); /* Virindi Executor */
/* @teleloc 0x4214003C [175.148800 76.050620 -0.871000] -0.999682 0.000000 0.000000 -0.025207 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x74214003,  7119, 0x42140034, 158.3138, 85.08562, -0.8935, 0.998247, 0, 0, -0.059181,  True, '2019-02-10 00:00:00'); /* Imperial Mu-miyah */
/* @teleloc 0x42140034 [158.313800 85.085620 -0.893500] 0.998247 0.000000 0.000000 -0.059181 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x74214004, 24319, 0x42140010, 36.93874, 190.53, 0.807518, 0.707107, 0, 0, -0.707107,  True, '2019-02-10 00:00:00'); /* Dark Master */
/* @teleloc 0x42140010 [36.938740 190.530000 0.807518] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x74214005, 24319, 0x42140010, 43.4901, 190.8524, 0.288444, 0.258819, 0, 0, -0.965926,  True, '2019-02-10 00:00:00'); /* Dark Master */
/* @teleloc 0x42140010 [43.490100 190.852400 0.288444] 0.258819 0.000000 0.000000 -0.965926 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x74214006, 24325, 0x42140010, 37.99278, 191.029, 0.761265, 0, 0, 0, -1,  True, '2019-02-10 00:00:00'); /* Phantasm */
/* @teleloc 0x42140010 [37.992780 191.029000 0.761265] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x74214007,  7119, 0x4214003C, 178.449, 92.83362, -0.8935, -0.999682, 0, 0, -0.025207,  True, '2019-02-10 00:00:00'); /* Imperial Mu-miyah */
/* @teleloc 0x4214003C [178.449000 92.833620 -0.893500] -0.999682 0.000000 0.000000 -0.025207 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x74214008,  7126, 0x4214002B, 120.9236, 71.87867, -0.899999, 0.998247, 0, 0, -0.059181,  True, '2019-02-10 00:00:00'); /* Cursed Wisp */
