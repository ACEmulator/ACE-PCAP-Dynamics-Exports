...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x726C1004, 11505, 0x26C1000C, 45.92281, 94.70853, 23.93952, 0.9730983, 0, 0, -0.2303904,  True, '2019-02-10 00:00:00'); /* Poacher */
/* @teleloc 0x26C1000C [45.922810 94.708530 23.939520] 0.973098 0.000000 0.000000 -0.230390 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x726C1005, 11491, 0x26C10024, 117.084, 82.3325, 37.748, 0.2198939, 0, 0, -0.9755238,  True, '2019-02-10 00:00:00'); /* Timber Siraluun */
/* @teleloc 0x26C10024 [117.084000 82.332500 37.748000] 0.219894 0.000000 0.000000 -0.975524 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x726C1006, 11491, 0x26C1002C, 120.6328, 86.81378, 38.09646, 0.2198939, 0, 0, -0.9755238,  True, '2019-02-10 00:00:00'); /* Timber Siraluun */
/* @teleloc 0x26C1002C [120.632800 86.813780 38.096460] 0.219894 0.000000 0.000000 -0.975524 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x726C1007, 11495, 0x26C1002E, 123.1089, 134.5673, 40.51814, 0.6129269, 0, 0, -0.7901396,  True, '2019-02-10 00:00:00'); /* Rabid Carenzi */
/* @teleloc 0x26C1002E [123.108900 134.567300 40.518140] 0.612927 0.000000 0.000000 -0.790140 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x726C1008, 27718, 0x26C10038, 153.0382, 174.5058, 52.26216, -0.7778319, 0, 0, -0.6284724,  True, '2019-02-10 00:00:00'); /* Woodland Ursuin */
