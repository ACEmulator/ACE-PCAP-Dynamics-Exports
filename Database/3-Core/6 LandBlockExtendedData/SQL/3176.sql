...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73176004, 14517, 0x31760028, 97.80116, 191.676, 79.39152, 0.2609443, 0, 0, -0.9653538,  True, '2019-02-10 00:00:00'); /* Frost */
/* @teleloc 0x31760028 [97.801160 191.676000 79.391520] 0.260944 0.000000 0.000000 -0.965354 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73176005, 20191, 0x31760028, 117.1549, 180.6484, 75.9183, 0.2609443, 0, 0, -0.9653538,  True, '2019-02-10 00:00:00'); /* Horripal */
/* @teleloc 0x31760028 [117.154900 180.648400 75.918300] 0.260944 0.000000 0.000000 -0.965354 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73176006, 24958, 0x31760028, 112.9984, 181.0083, 77.49203, 0.2609443, 0, 0, -0.9653538,  True, '2019-02-10 00:00:00'); /* Olthoi Lancer */
/* @teleloc 0x31760028 [112.998400 181.008300 77.492030] 0.260944 0.000000 0.000000 -0.965354 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73176007, 24283, 0x31760008, 8.939957, 190.6217, 63.72953, 0.3437017, 0, 0, -0.9390789,  True, '2019-02-10 00:00:00'); /* Drudge Sage */
/* @teleloc 0x31760008 [8.939957 190.621700 63.729530] 0.343702 0.000000 0.000000 -0.939079 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73176008,  7346, 0x31760039, 177.9099, 1.40097, 94.71999, 0.9096489, 0, 0, -0.4153779,  True, '2019-02-10 00:00:00'); /* Banderling Enforcer */
