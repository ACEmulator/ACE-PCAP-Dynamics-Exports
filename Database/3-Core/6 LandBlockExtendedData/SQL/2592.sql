...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72592005, 11540, 0x2592001A, 78.79399, 31.91962, 222.0903, 0.4055685, 0, 0, -0.9140646,  True, '2019-02-10 00:00:00'); /* Armored Tusker */
/* @teleloc 0x2592001A [78.793990 31.919620 222.090300] 0.405569 0.000000 0.000000 -0.914065 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72592006, 36840, 0x25920035, 151.4962, 100.7044, 212.3187, 0.9987252, 0, 0, -0.05047787,  True, '2019-02-10 00:00:00'); /* Bloodthirsty Monouga */
