...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x70122009,  1542, 0x01220105, 24.10119, -10.59062, -0.002499998, 0.1320467, 0, 0, -0.9912435, False, '2019-02-10 00:00:00'); /* Linkable Item Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7012200A, 24366, 0x01220105, 24.10119, -10.59062, -0.002499998, 0.1320467, 0, 0, -0.9912435,  True, '2019-02-10 00:00:00'); /* Asheron's Greater Raiment */
/* @teleloc 0x01220105 [24.101190 -10.590620 -0.002500] 0.132047 0.000000 0.000000 -0.991244 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7012200B, 39369, 0x01220105, 24.10119, -10.59062, 0.11875, 0.1320467, 0, 0, -0.9912435,  True, '2019-02-10 00:00:00'); /* Pack T'thuun */
/* @teleloc 0x01220105 [24.101190 -10.590620 0.118750] 0.132047 0.000000 0.000000 -0.991244 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7012200C, 52367, 0x0122010C, 33.29057, -11.10078, 0.002499998, -0.08212787, 0, 0, -0.9966218,  True, '2019-02-10 00:00:00'); /* Pack Gurog */
/* @teleloc 0x0122010C [33.290570 -11.100780 0.002500] -0.082128 0.000000 0.000000 -0.996622 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7012200D,  1955, 0x01220112, 42.73031, -26.32595, -0.06299996, -0.1880355, 0, 0, 0.9821622,  True, '2019-02-10 00:00:00'); /* Gateway */
/* @teleloc 0x01220112 [42.730310 -26.325950 -0.063000] -0.188036 0.000000 0.000000 0.982162 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7012200E, 30234, 0x01220106, 23.87314, -19.69164, -0.001000002, 0.3958175, 0, 0, -0.9183292,  True, '2019-02-10 00:00:00'); /* Lich's Pearl */
/* @teleloc 0x01220106 [23.873140 -19.691640 -0.001000] 0.395818 0.000000 0.000000 -0.918329 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7012200F,  1955, 0x0122010C, 27.636, -13.79132, 0.4494849, 0.9217951, 0, 0, -0.3876774,  True, '2019-02-10 00:00:00'); /* Gateway */
/* @teleloc 0x0122010C [27.636000 -13.791320 0.449485] 0.921795 0.000000 0.000000 -0.387677 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x70122010,  1955, 0x0122010D, 33.44149, -16.60346, 0.4494952, 1, 0, 0, -0.0001117137,  True, '2019-02-10 00:00:00'); /* Gateway */
/* @teleloc 0x0122010D [33.441490 -16.603460 0.449495] 1.000000 0.000000 0.000000 -0.000112 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x70122011,  1955, 0x01220112, 41.44816, -29.59674, -0.06299996, 0.01636137, 0, 0, 0.9998661,  True, '2019-02-10 00:00:00'); /* Gateway */
