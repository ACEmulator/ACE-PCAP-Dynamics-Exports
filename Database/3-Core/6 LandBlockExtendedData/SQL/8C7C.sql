...
VALUES (0x78C7C001,  1154, 0x8C7C0023, 112.8419, 53.26281, 180.012, -0.5797083, 0, 0, -0.814824, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78C7C003,  1606, 0x8C7C0022, 111.9711, 40.77915, 180.0085, -0.9730601, 0, 0, -0.2305518,  True, '2019-02-10 00:00:00'); /* Auroch Fire Cow */
