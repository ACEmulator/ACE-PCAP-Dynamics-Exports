...
VALUES (0x74166001,  1154, 0x4166002B, 127.4524, 58.40644, 0.0065, -0.999018, 0, 0, -0.044316, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x74166002,  8431, 0x4166002B, 127.4524, 58.40644, 0.0065, -0.999018, 0, 0, -0.044316,  True, '2019-02-10 00:00:00'); /* Nomad Mu-miyah */
/* @teleloc 0x4166002B [127.452400 58.406440 0.006500] -0.999018 0.000000 0.000000 -0.044316 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x74166003, 23564, 0x41660032, 158.2669, 35.27747, 0.005, 0.902081, 0, 0, -0.431568,  True, '2019-02-10 00:00:00'); /* Tenebrous Shadow */
/* @teleloc 0x41660032 [158.266900 35.277470 0.005000] 0.902081 0.000000 0.000000 -0.431568 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x74166004, 36858, 0x4166003A, 168.6208, 39.75546, 0.209442, -0.774477, 0, 0, -0.632602,  True, '2019-02-10 00:00:00'); /* Great Skeleton */
/* @teleloc 0x4166003A [168.620800 39.755460 0.209442] -0.774477 0.000000 0.000000 -0.632602 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x74166005, 24497, 0x41660018, 54.35595, 179.9532, 10.30236, -0.766044, 0, 0, -0.642788,  True, '2019-02-10 00:00:00'); /* Gotrok Tiatus */
/* @teleloc 0x41660018 [54.355950 179.953200 10.302360] -0.766044 0.000000 0.000000 -0.642788 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x74166006, 24497, 0x41660018, 60.97382, 188.6575, 10.84923, 0.258819, 0, 0, -0.965926,  True, '2019-02-10 00:00:00'); /* Gotrok Tiatus */
/* @teleloc 0x41660018 [60.973820 188.657500 10.849230] 0.258819 0.000000 0.000000 -0.965926 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x74166007,  8431, 0x4166001F, 74.44907, 158.401, 0.0065, -0.633682, 0, 0, -0.773593,  True, '2019-02-10 00:00:00'); /* Nomad Mu-miyah */
