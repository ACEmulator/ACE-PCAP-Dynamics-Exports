...
VALUES (0x779C3001, 0x779C3002, '2019-02-10 00:00:00') /* Banderling Thrasher */
     , (0x779C3001, 0x779C3003, '2019-02-10 00:00:00') /* Umbris Shadow */
     , (0x779C3001, 0x779C3004, '2019-02-10 00:00:00') /* Panumbris Shadow */
     , (0x779C3001, 0x779C3005, '2019-02-10 00:00:00') /* Shadow */
     , (0x779C3001, 0x779C3006, '2019-02-10 00:00:00') /* Umbris Shadow */
     , (0x779C3001, 0x779C3007, '2019-02-10 00:00:00') /* Altered Drudge */
     , (0x779C3001, 0x779C3008, '2019-02-10 00:00:00') /* Shadow Lieutenant */
     , (0x779C3001, 0x779C3009, '2019-02-10 00:00:00') /* Plate Armoredillo */;
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x779C3003,  4254, 0x79C3001C, 82.41467, 87.01514, 290.4964, 0.8870109, 0, 0, -0.4617486,  True, '2019-02-10 00:00:00'); /* Umbris Shadow */
/* @teleloc 0x79C3001C [82.414670 87.015140 290.496400] 0.887011 0.000000 0.000000 -0.461749 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x779C3004,  4253, 0x79C3001C, 80.81467, 82.89491, 294.7961, 0.7071068, 0, 0, -0.7071068,  True, '2019-02-10 00:00:00'); /* Panumbris Shadow */
/* @teleloc 0x79C3001C [80.814670 82.894910 294.796100] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x779C3005,  1758, 0x79C3001C, 76.01466, 82.89491, 294.7961, 0.7071068, 0, 0, -0.7071068,  True, '2019-02-10 00:00:00'); /* Shadow */
/* @teleloc 0x79C3001C [76.014660 82.894910 294.796100] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x779C3006,  4254, 0x79C3001C, 80.81467, 87.69492, 294.7961, 0.9238795, 0, 0, -0.3826835,  True, '2019-02-10 00:00:00'); /* Umbris Shadow */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x779C3008,  1757, 0x79C3001C, 76.01466, 87.69492, 294.7961, 0.7071068, 0, 0, -0.7071068,  True, '2019-02-10 00:00:00'); /* Shadow Lieutenant */
/* @teleloc 0x79C3001C [76.014660 87.694920 294.796100] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x779C3009,  7081, 0x79C3001C, 72.50256, 72.08, 297.9705, 0.8503938, 0, 0, -0.5261467,  True, '2019-02-10 00:00:00'); /* Plate Armoredillo */
...
INSERT INTO `landblock_instance_link` (`parent_GUID`, `child_GUID`, `last_Modified`)
VALUES (0x779C300A, 0x779C300B, '2019-02-10 00:00:00') /* Runed Chest */;
