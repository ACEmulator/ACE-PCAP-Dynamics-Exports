...
VALUES (0x72A9A001,  1154, 0x2A9A0008, 12.50448, 190.0169, 30.0065, 0.9952905, 0, 0, -0.09693763, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72A9A003, 14516, 0x2A9A0008, 10.1333, 180.5738, 30.0075, 0.9952905, 0, 0, -0.09693763,  True, '2019-02-10 00:00:00'); /* Caustic */
/* @teleloc 0x2A9A0008 [10.133300 180.573800 30.007500] 0.995291 0.000000 0.000000 -0.096938 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72A9A004,  7982, 0x2A9A0005, 13.98598, 110.8917, 43.79305, 0.7802032, 0, 0, -0.6255261,  True, '2019-02-10 00:00:00'); /* Destroyer Grievver */
/* @teleloc 0x2A9A0005 [13.985980 110.891700 43.793050] 0.780203 0.000000 0.000000 -0.625526 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72A9A005, 36827, 0x2A9A0014, 67.54265, 95.46473, 42.09026, -0.9039803, 0, 0, -0.4275742,  True, '2019-02-10 00:00:00'); /* Acidic Coral Golem */
/* @teleloc 0x2A9A0014 [67.542650 95.464730 42.090260] -0.903980 0.000000 0.000000 -0.427574 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x72A9A006, 36827, 0x2A9A0025, 98.36025, 107.902, 30.01, -0.9039803, 0, 0, -0.4275742,  True, '2019-02-10 00:00:00'); /* Acidic Coral Golem */
