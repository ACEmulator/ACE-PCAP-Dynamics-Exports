...
VALUES (0x7938C001,  1154, 0x938C003A, 170.2406, 47.5196, 32.005, 0.707107, 0, 0, -0.707107, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7938C002,  1758, 0x938C003A, 170.2406, 47.5196, 32.005, 0.707107, 0, 0, -0.707107,  True, '2019-02-10 00:00:00'); /* Shadow */
/* @teleloc 0x938C003A [170.240600 47.519600 32.005000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7938C003,   195, 0x938C0021, 117.1316, 11.9056, 33.2579, -0.118347, 0, 0, -0.992972,  True, '2019-02-10 00:00:00'); /* Granite Golem */
/* @teleloc 0x938C0021 [117.131600 11.905600 33.257900] -0.118347 0.000000 0.000000 -0.992972 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7938C004,   195, 0x938C003C, 179.4274, 81.82959, 32.011, 0.92388, 0, 0, -0.382684,  True, '2019-02-10 00:00:00'); /* Granite Golem */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7938C007, 15715, 0x938C0009, 28.67988, 0.044144, 34.38781, -0.90571, 0, 0, -0.423898,  True, '2019-02-10 00:00:00'); /* Sunflower */
/* @teleloc 0x938C0009 [28.679880 0.044144 34.387810] -0.905710 0.000000 0.000000 -0.423898 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7938C008,   621, 0x938C003C, 179.7359, 84.04427, 32.02932, 0.766045, 0, 0, -0.642788,  True, '2019-02-10 00:00:00'); /* Heavy Bracelet */
/* @teleloc 0x938C003C [179.735900 84.044270 32.029320] 0.766045 0.000000 0.000000 -0.642788 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7938C009,  2432, 0x938C003C, 179.7359, 84.04427, 31.999, 0.766045, 0, 0, -0.642788,  True, '2019-02-10 00:00:00'); /* Gem */
