...
VALUES (0x7373C001,  1154, 0x373C0012, 71.0677, 28.17567, -0.09175, 0.514794, 0, 0, -0.857314, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7373C002, 24320, 0x373C0012, 71.0677, 28.17567, -0.09175, 0.514794, 0, 0, -0.857314,  True, '2019-02-10 00:00:00'); /* Great Revenant */
/* @teleloc 0x373C0012 [71.067700 28.175670 -0.091750] 0.514794 0.000000 0.000000 -0.857314 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7373C003,  9264, 0x373C0012, 70.2743, 35.58616, -0.071, 0.617294, 0, 0, -0.786733,  True, '2019-02-10 00:00:00'); /* Virindi Executor */
/* @teleloc 0x373C0012 [70.274300 35.586160 -0.071000] 0.617294 0.000000 0.000000 -0.786733 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7373C004, 36829, 0x373C0019, 76.17336, 19.87687, 0.01, 0.617294, 0, 0, -0.786733,  True, '2019-02-10 00:00:00'); /* Acidic Diamond Golem */
/* @teleloc 0x373C0019 [76.173360 19.876870 0.010000] 0.617294 0.000000 0.000000 -0.786733 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7373C005,  8431, 0x373C0012, 49.63349, 37.07424, -0.4435, 0.953717, 0, 0, -0.300706,  True, '2019-02-10 00:00:00'); /* Nomad Mu-miyah */
/* @teleloc 0x373C0012 [49.633490 37.074240 -0.443500] 0.953717 0.000000 0.000000 -0.300706 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7373C006,  8431, 0x373C000A, 46.75164, 36.34283, -0.4435, 0.422618, 0, 0, -0.906308,  True, '2019-02-10 00:00:00'); /* Nomad Mu-miyah */
/* @teleloc 0x373C000A [46.751640 36.342830 -0.443500] 0.422618 0.000000 0.000000 -0.906308 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7373C007, 36829, 0x373C001B, 82.86963, 49.75133, -0.44, 0.617294, 0, 0, -0.786733,  True, '2019-02-10 00:00:00'); /* Acidic Diamond Golem */
/* @teleloc 0x373C001B [82.869630 49.751330 -0.440000] 0.617294 0.000000 0.000000 -0.786733 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7373C008,  7113, 0x373C001A, 84.1308, 37.1338, -0.46875, 0.62932, 0, 0, -0.777146,  True, '2019-02-10 00:00:00'); /* Gauloth Shreth */
/* @teleloc 0x373C001A [84.130800 37.133800 -0.468750] 0.629320 0.000000 0.000000 -0.777146 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7373C009,  7113, 0x373C001A, 85.0822, 39.34623, -0.46875, 0.737277, 0, 0, -0.67559,  True, '2019-02-10 00:00:00'); /* Gauloth Shreth */
/* @teleloc 0x373C001A [85.082200 39.346230 -0.468750] 0.737277 0.000000 0.000000 -0.675590 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7373C00A,  7113, 0x373C001A, 82.90413, 41.63883, -0.46875, -0.173648, 0, 0, -0.984808,  True, '2019-02-10 00:00:00'); /* Gauloth Shreth */
