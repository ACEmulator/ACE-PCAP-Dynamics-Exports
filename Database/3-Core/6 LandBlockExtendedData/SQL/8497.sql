...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78497009, 22009, 0x84970023, 118.5322, 65.8038, 124, 0.9875843, 0, 0, -0.15709,  True, '2019-02-10 00:00:00'); /* Olthoi Drone */
/* @teleloc 0x84970023 [118.532200 65.803800 124.000000] 0.987584 0.000000 0.000000 -0.157090 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7849700A,  7978, 0x8497002B, 122.1619, 55.30655, 123.9985, 0.8660254, 0, 0, -0.5,  True, '2019-02-10 00:00:00'); /* Scrawed Grievver */
/* @teleloc 0x8497002B [122.161900 55.306550 123.998500] 0.866025 0.000000 0.000000 -0.500000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7849700B,  7978, 0x84970023, 114.4016, 57.31346, 123.9985, 0.8191521, 0, 0, -0.5735765,  True, '2019-02-10 00:00:00'); /* Scrawed Grievver */
/* @teleloc 0x84970023 [114.401600 57.313460 123.998500] 0.819152 0.000000 0.000000 -0.573577 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7849700C, 36443, 0x8497002B, 142.3369, 61.74457, 124.0065, 0.9875843, 0, 0, -0.15709,  True, '2019-02-10 00:00:00'); /* Harvest Reaper */
/* @teleloc 0x8497002B [142.336900 61.744570 124.006500] 0.987584 0.000000 0.000000 -0.157090 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7849700D,   217, 0x8497002C, 128.7468, 75.7737, 124.013, 0.9875843, 0, 0, -0.15709,  True, '2019-02-10 00:00:00'); /* Gold Phyntos Wasp */
/* @teleloc 0x8497002C [128.746800 75.773700 124.013000] 0.987584 0.000000 0.000000 -0.157090 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7849700E,  1542, 0x8497002F, 122.3731, 151.0458, 138.3262, 0.2330544, 0, 0, -0.9724637, False, '2019-02-10 00:00:00'); /* Linkable Item Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7849700F, 34132, 0x8497002F, 122.3731, 151.0458, 138.3262, 0.2330544, 0, 0, -0.9724637,  True, '2019-02-10 00:00:00'); /* Old Gravestone */
/* @teleloc 0x8497002F [122.373100 151.045800 138.326200] 0.233054 0.000000 0.000000 -0.972464 */
