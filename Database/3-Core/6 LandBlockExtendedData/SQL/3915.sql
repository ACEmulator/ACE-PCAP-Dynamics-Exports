...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73915004, 21551, 0x3915002A, 129.7015, 41.65639, 18.14077, 0.4655312, 0, 0, -0.8850315,  True, '2019-02-10 00:00:00'); /* Strife Wisp */
/* @teleloc 0x3915002A [129.701500 41.656390 18.140770] 0.465531 0.000000 0.000000 -0.885032 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73915005,  7119, 0x3915003A, 191.0671, 32.31373, 10.62157, -0.8032596, 0, 0, -0.595629,  True, '2019-02-10 00:00:00'); /* Imperial Mu-miyah */
/* @teleloc 0x3915003A [191.067100 32.313730 10.621570] -0.803260 0.000000 0.000000 -0.595629 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73915006,  5710, 0x3915003F, 169.7102, 167.8009, 10.005, -0.1530162, 0, 0, -0.9882237,  True, '2019-02-10 00:00:00'); /* Flare */
/* @teleloc 0x3915003F [169.710200 167.800900 10.005000] -0.153016 0.000000 0.000000 -0.988224 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73915007,  5712, 0x39150040, 174.9304, 168.7762, 10.0085, -0.1530162, 0, 0, -0.9882237,  True, '2019-02-10 00:00:00'); /* Inferno */
/* @teleloc 0x39150040 [174.930400 168.776200 10.008500] -0.153016 0.000000 0.000000 -0.988224 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73915008,  5711, 0x39150040, 169.4658, 179.9578, 10.0065, -0.1530162, 0, 0, -0.9882237,  True, '2019-02-10 00:00:00'); /* Flamma */
