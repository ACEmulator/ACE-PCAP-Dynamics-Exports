...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x74464008,   228, 0x4464003A, 178.3311, 24.62534, 34.74512, 0.6833981, 0, 0, -0.7300459,  True, '2019-02-10 00:00:00'); /* Tumerok High Priest */
/* @teleloc 0x4464003A [178.331100 24.625340 34.745120] 0.683398 0.000000 0.000000 -0.730046 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x74464009, 36858, 0x44640039, 189.2818, 14.25198, 34.88595, 0.6833981, 0, 0, -0.7300459,  True, '2019-02-10 00:00:00'); /* Great Skeleton */
/* @teleloc 0x44640039 [189.281800 14.251980 34.885950] 0.683398 0.000000 0.000000 -0.730046 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7446400A,  7119, 0x44640008, 16.61893, 185.6759, 20.0065, -0.9078853, 0, 0, -0.4192188,  True, '2019-02-10 00:00:00'); /* Imperial Mu-miyah */
