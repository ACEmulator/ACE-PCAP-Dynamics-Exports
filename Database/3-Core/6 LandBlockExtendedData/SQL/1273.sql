...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x71273004, 41534, 0x12730024, 104.0385, 89.32839, 71.34331, 0.9453435, 0, 0, -0.3260762,  True, '2019-02-10 00:00:00'); /* Invading Iron Blade Phalanx */
/* @teleloc 0x12730024 [104.038500 89.328390 71.343310] 0.945344 0.000000 0.000000 -0.326076 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x71273005, 41535, 0x12730025, 102.9607, 104.2982, 76.19424, 0.9453435, 0, 0, -0.3260762,  True, '2019-02-10 00:00:00'); /* Invading Silver Scope Phalanx */
/* @teleloc 0x12730025 [102.960700 104.298200 76.194240] 0.945344 0.000000 0.000000 -0.326076 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x71273006, 41534, 0x12730025, 104.3703, 99.72904, 71.73654, 0.9453435, 0, 0, -0.3260762,  True, '2019-02-10 00:00:00'); /* Invading Iron Blade Phalanx */
/* @teleloc 0x12730025 [104.370300 99.729040 71.736540] 0.945344 0.000000 0.000000 -0.326076 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x71273007,  7981, 0x1273003A, 186.5165, 30.40909, 98.38908, 0.8660254, 0, 0, -0.5,  True, '2019-02-10 00:00:00'); /* Harrower Grievver */
