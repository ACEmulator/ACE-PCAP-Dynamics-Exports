...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x727C2006, 11520, 0x27C20029, 136.9836, 3.271311, 46.35758, -0.460042, 0, 0, -0.8878971,  True, '2019-02-10 00:00:00'); /* Hea Nualuan */
/* @teleloc 0x27C20029 [136.983600 3.271311 46.357580] -0.460042 0.000000 0.000000 -0.887897 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x727C2007, 11540, 0x27C20023, 106.0236, 50.08348, 45.00428, -0.3407843, 0, 0, -0.9401416,  True, '2019-02-10 00:00:00'); /* Armored Tusker */
/* @teleloc 0x27C20023 [106.023600 50.083480 45.004280] -0.340784 0.000000 0.000000 -0.940142 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x727C2008, 11486, 0x27C20002, 1.695821, 32.61243, 68.28175, -0.9788138, 0, 0, -0.2047524,  True, '2019-02-10 00:00:00'); /* Kithless Siraluun */
