...
VALUES (0x77415001,  1154, 0x74150009, 40.35002, 6.370605, 3.370002, -0.543155, 0, 0, -0.839632, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x77415002,  7123, 0x74150009, 40.35002, 6.370605, 3.370002, -0.543155, 0, 0, -0.839632,  True, '2019-02-10 00:00:00'); /* Dark Leech */
/* @teleloc 0x74150009 [40.350020 6.370605 3.370002] -0.543155 0.000000 0.000000 -0.839632 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x77415003,  7124, 0x74150007, 7.832907, 158.5571, 6.618469, 0.993024, 0, 0, -0.117912,  True, '2019-02-10 00:00:00'); /* Dark Magus */
/* @teleloc 0x74150007 [7.832907 158.557100 6.618469] 0.993024 0.000000 0.000000 -0.117912 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x77415004,  8968, 0x74150009, 33.71748, 22.70751, 3.514373, -0.543155, 0, 0, -0.839632,  True, '2019-02-10 00:00:00'); /* Fleshless Warrior */
/* @teleloc 0x74150009 [33.717480 22.707510 3.514373] -0.543155 0.000000 0.000000 -0.839632 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x77415005,  7780, 0x74150009, 32.63288, 0.182373, 2.721907, -0.543155, 0, 0, -0.839632,  True, '2019-02-10 00:00:00'); /* Ashen Bones */
/* @teleloc 0x74150009 [32.632880 0.182373 2.721907] -0.543155 0.000000 0.000000 -0.839632 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x77415006, 24497, 0x74150011, 51.2928, 20.61823, 6.276986, -0.766044, 0, 0, -0.642788,  True, '2019-02-10 00:00:00'); /* Gotrok Tiatus */
/* @teleloc 0x74150011 [51.292800 20.618230 6.276986] -0.766044 0.000000 0.000000 -0.642788 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x77415007, 24497, 0x74150011, 58.8928, 16.11823, 7.168652, 0.92388, 0, 0, -0.382684,  True, '2019-02-10 00:00:00'); /* Gotrok Tiatus */
/* @teleloc 0x74150011 [58.892800 16.118230 7.168652] 0.923880 0.000000 0.000000 -0.382684 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x77415008, 24497, 0x74150009, 42.8928, 13.61823, 4.293652, 0.258819, 0, 0, -0.965926,  True, '2019-02-10 00:00:00'); /* Gotrok Tiatus */
