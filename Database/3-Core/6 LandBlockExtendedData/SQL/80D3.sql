...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x780D3006, 20191, 0x80D30017, 67.89011, 159.0699, 194.1056, -0.7885761, 0, 0, -0.6149371,  True, '2019-02-10 00:00:00'); /* Horripal */
/* @teleloc 0x80D30017 [67.890110 159.069900 194.105600] -0.788576 0.000000 0.000000 -0.614937 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x780D3007,  7090, 0x80D30032, 152.1566, 42.835, 166.322, -0.7162036, 0, 0, -0.6978914,  True, '2019-02-10 00:00:00'); /* Augmented Drudge */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x780D300A, 11555, 0x80D30026, 116.5605, 136.9385, 189.0729, -0.6594146, 0, 0, -0.7517795,  True, '2019-02-10 00:00:00'); /* Relanim Plant */
