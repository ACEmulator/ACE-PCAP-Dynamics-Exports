...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7304600C, 36829, 0x30460035, 162.3651, 115.784, 17.78648, -0.1141899, 0, 0, -0.9934589,  True, '2019-02-10 00:00:00'); /* Acidic Diamond Golem */
/* @teleloc 0x30460035 [162.365100 115.784000 17.786480] -0.114190 0.000000 0.000000 -0.993459 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7304600D, 27987, 0x3046003E, 187.5495, 143.6793, 17.11447, 0.9063078, 0, 0, -0.4226183,  True, '2019-02-10 00:00:00'); /* Guruk Heavy */
/* @teleloc 0x3046003E [187.549500 143.679300 17.114470] 0.906308 0.000000 0.000000 -0.422618 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7304600E, 21551, 0x30460035, 159.8193, 114.8013, 12.75201, -0.1141899, 0, 0, -0.9934589,  True, '2019-02-10 00:00:00'); /* Strife Wisp */
/* @teleloc 0x30460035 [159.819300 114.801300 12.752010] -0.114190 0.000000 0.000000 -0.993459 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7304600F, 23488, 0x3046003E, 183.4405, 129.6043, 19.70635, 0.7071068, 0, 0, -0.7071068,  True, '2019-02-10 00:00:00'); /* Ulu Sclavus Lord */
/* @teleloc 0x3046003E [183.440500 129.604300 19.706350] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73046010, 23616, 0x3046003F, 171.2729, 144.1726, 27.76055, -0.9820987, 0, 0, -0.1883672,  True, '2019-02-10 00:00:00'); /* Crystal Shard */
/* @teleloc 0x3046003F [171.272900 144.172600 27.760550] -0.982099 0.000000 0.000000 -0.188367 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x73046011, 26019, 0x3046003F, 189.7338, 151.4381, 14.01823, 0.8660254, 0, 0, -0.5,  True, '2019-02-10 00:00:00'); /* Burun Ruuk Seer */
