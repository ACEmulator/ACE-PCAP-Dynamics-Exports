...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7C19D004,   223, 0xC19D003A, 187.7099, 31.51312, 1.551, -0.4290815, 0, 0, -0.9032658,  True, '2019-02-10 00:00:00'); /* Reedshark Pup */
/* @teleloc 0xC19D003A [187.709900 31.513120 1.551000] -0.429082 0.000000 0.000000 -0.903266 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7C19D005,   177, 0xC19D0036, 152.9912, 132.25, 1.108925, 0.8660254, 0, 0, -0.5,  True, '2019-02-10 00:00:00'); /* Spiny Armoredillo */
/* @teleloc 0xC19D0036 [152.991200 132.250000 1.108925] 0.866025 0.000000 0.000000 -0.500000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7C19D006,  7985, 0xC19D003A, 176.1347, 28.502, 1.9003, -0.4290815, 0, 0, -0.9032658,  True, '2019-02-10 00:00:00'); /* Listris Niffis */
