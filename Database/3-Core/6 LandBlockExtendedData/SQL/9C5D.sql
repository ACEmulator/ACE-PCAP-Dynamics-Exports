...
VALUES (0x79C5D001,  1154, 0x9C5D001F, 88.30531, 144.7606, 20.09, 0.7071068, 0, 0, -0.7071068, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x79C5D003,  1756, 0x9C5D001E, 87.11903, 142.1314, 20.09, 0.8870109, 0, 0, -0.4617486,  True, '2019-02-10 00:00:00'); /* Shadow Child */
/* @teleloc 0x9C5D001E [87.119030 142.131400 20.090000] 0.887011 0.000000 0.000000 -0.461749 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x79C5D004,   238, 0x9C5D0037, 151.9358, 151.7662, 26.05726, 0.9964964, 0, 0, -0.08363585,  True, '2019-02-10 00:00:00'); /* Virindi Puppet */
/* @teleloc 0x9C5D0037 [151.935800 151.766200 26.057260] 0.996496 0.000000 0.000000 -0.083636 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x79C5D005,  1630, 0x9C5D0024, 97.16021, 84.73515, 21.16545, 0.5469541, 0, 0, -0.8371626,  True, '2019-02-10 00:00:00'); /* Lich Lord */
/* @teleloc 0x9C5D0024 [97.160210 84.735150 21.165450] 0.546954 0.000000 0.000000 -0.837163 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x79C5D006,  1630, 0x9C5D0024, 112.6623, 88.21263, 22.78455, 0.9659258, 0, 0, -0.258819,  True, '2019-02-10 00:00:00'); /* Lich Lord */
/* @teleloc 0x9C5D0024 [112.662300 88.212630 22.784550] 0.965926 0.000000 0.000000 -0.258819 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x79C5D007,  1630, 0x9C5D0024, 109.8687, 87.49427, 22.45442, 0.8870109, 0, 0, -0.4617486,  True, '2019-02-10 00:00:00'); /* Lich Lord */
/* @teleloc 0x9C5D0024 [109.868700 87.494270 22.454420] 0.887011 0.000000 0.000000 -0.461749 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x79C5D008,  9242, 0x9C5D002B, 124.3491, 63.80028, 22.66238, -0.3322863, 0, 0, -0.9431786,  True, '2019-02-10 00:00:00'); /* Innocent Doll */
