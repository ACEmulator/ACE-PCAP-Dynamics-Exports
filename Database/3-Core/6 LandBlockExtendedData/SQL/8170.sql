...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78170004,   232, 0x81700030, 132.3908, 187.5945, 12.67412, -0.962971, 0, 0, -0.269606,  True, '2019-02-10 00:00:00'); /* Tumerok Scout */
/* @teleloc 0x81700030 [132.390800 187.594500 12.674120] -0.962971 0.000000 0.000000 -0.269606 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78170005,   949, 0x8170003F, 185.6247, 144.1282, 15.07175, 0.567557, 0, 0, -0.823334,  True, '2019-02-10 00:00:00'); /* Red Rat */
/* @teleloc 0x8170003F [185.624700 144.128200 15.071750] 0.567557 0.000000 0.000000 -0.823334 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78170006, 10773, 0x81700028, 119.9167, 180.8611, 14.029, -0.962971, 0, 0, -0.269606,  True, '2019-02-10 00:00:00'); /* Broken Doll */
/* @teleloc 0x81700028 [119.916700 180.861100 14.029000] -0.962971 0.000000 0.000000 -0.269606 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78170007,  1766, 0x81700036, 157.0612, 137.1888, 16.18527, -0.816924, 0, 0, -0.576745,  True, '2019-02-10 00:00:00'); /* Stony Armoredillo */
/* @teleloc 0x81700036 [157.061200 137.188800 16.185270] -0.816924 0.000000 0.000000 -0.576745 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78170008,   178, 0x8170003F, 176.4839, 166.8865, 14.19556, 0.567557, 0, 0, -0.823334,  True, '2019-02-10 00:00:00'); /* Brown Armoredillo */
