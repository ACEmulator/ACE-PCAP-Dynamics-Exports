...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x722DC005, 29356, 0x22DC0022, 99.80817, 30.47853, 8.009, 0.9548984, 0, 0, -0.296933,  True, '2019-02-10 00:00:00'); /* Damaged Glacial Golem */
/* @teleloc 0x22DC0022 [99.808170 30.478530 8.009000] 0.954898 0.000000 0.000000 -0.296933 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x722DC006, 28666, 0x22DC002B, 133.2896, 50.93797, 13.18992, 0.02054233, 0, 0, -0.999789,  True, '2019-02-10 00:00:00'); /* Ruschk Slayer */
/* @teleloc 0x22DC002B [133.289600 50.937970 13.189920] 0.020542 0.000000 0.000000 -0.999789 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x722DC007, 24959, 0x22DC0033, 145.7162, 55.18052, 12.53937, 0.02054233, 0, 0, -0.999789,  True, '2019-02-10 00:00:00'); /* Olthoi Needler */
/* @teleloc 0x22DC0033 [145.716200 55.180520 12.539370] 0.020542 0.000000 0.000000 -0.999789 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x722DC008, 28671, 0x22DC001A, 92.47671, 43.43484, 8.0066, 0.9548984, 0, 0, -0.296933,  True, '2019-02-10 00:00:00'); /* Ruschk Shatterer */
/* @teleloc 0x22DC001A [92.476710 43.434840 8.006600] 0.954898 0.000000 0.000000 -0.296933 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x722DC009, 28678, 0x22DC001B, 89.87946, 53.41192, 8.901988, 0.9548984, 0, 0, -0.296933,  True, '2019-02-10 00:00:00'); /* Beefsteak Thrungus */
/* @teleloc 0x22DC001B [89.879460 53.411920 8.901988] 0.954898 0.000000 0.000000 -0.296933 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x722DC00A, 28673, 0x22DC002A, 133.1167, 35.48291, 8, 0.02054233, 0, 0, -0.999789,  True, '2019-02-10 00:00:00'); /* Deathcap Thrungus */
/* @teleloc 0x22DC002A [133.116700 35.482910 8.000000] 0.020542 0.000000 0.000000 -0.999789 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x722DC00B, 28649, 0x22DC0022, 116.4583, 31.0494, 7.995492, 0.9548984, 0, 0, -0.296933,  True, '2019-02-10 00:00:00'); /* Crazed Fiun */
