...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x796C1004,   213, 0x96C10032, 158.6569, 29.67982, 115.832, -0.9287093, 0, 0, -0.3708087,  True, '2019-02-10 00:00:00'); /* Olthoi Nymph */
/* @teleloc 0x96C10032 [158.656900 29.679820 115.832000] -0.928709 0.000000 0.000000 -0.370809 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x796C1005,  2576, 0x96C10017, 62.68256, 151.3093, 56.99766, 0.9063078, 0, 0, -0.4226183,  True, '2019-02-10 00:00:00'); /* Wild Monouga */
/* @teleloc 0x96C10017 [62.682560 151.309300 56.997660] 0.906308 0.000000 0.000000 -0.422618 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x796C1006, 24959, 0x96C10023, 119.1831, 70.48268, 111.6581, 0.003348658, 0, 0, -0.9999944,  True, '2019-02-10 00:00:00'); /* Olthoi Needler */
/* @teleloc 0x96C10023 [119.183100 70.482680 111.658100] 0.003349 0.000000 0.000000 -0.999994 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x796C1007,     3, 0x96C1002C, 130.0854, 77.34477, 111.6581, 0.003348658, 0, 0, -0.9999944,  True, '2019-02-10 00:00:00'); /* Olthoi Worker */
/* @teleloc 0x96C1002C [130.085400 77.344770 111.658100] 0.003349 0.000000 0.000000 -0.999994 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x796C1008, 11528, 0x96C10004, 2.668701, 90.16174, 69.91434, 0.2580309, 0, 0, -0.9661366,  True, '2019-02-10 00:00:00'); /* Elaniwood Golem */
