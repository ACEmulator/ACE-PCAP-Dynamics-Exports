...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x790EE00B,  7096, 0x90EE0006, 15.74172, 138.8633, 2.27013, 0.9760059, 0, 0, -0.2177439,  True, '2019-02-10 00:00:00'); /* Gold Golem */
/* @teleloc 0x90EE0006 [15.741720 138.863300 2.270130] 0.976006 0.000000 0.000000 -0.217744 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x790EE00C,  7096, 0x90EE0001, 20.47244, 13.47876, 2.88677, -0.7471507, 0, 0, -0.6646547,  True, '2019-02-10 00:00:00'); /* Gold Golem */
/* @teleloc 0x90EE0001 [20.472440 13.478760 2.886770] -0.747151 0.000000 0.000000 -0.664655 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x790EE00D,  7129, 0x90EE0015, 68.60252, 101.0316, 0.01499999, -0.976291, 0, 0, -0.2164623,  True, '2019-02-10 00:00:00'); /* Nalif Zefir */
/* @teleloc 0x90EE0015 [68.602520 101.031600 0.015000] -0.976291 0.000000 0.000000 -0.216462 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x790EE00E,  7096, 0x90EE0011, 55.79, 6.734589, 3.448784, 0.6060132, 0, 0, -0.7954546,  True, '2019-02-10 00:00:00'); /* Gold Golem */
/* @teleloc 0x90EE0011 [55.790000 6.734589 3.448784] 0.606013 0.000000 0.000000 -0.795455 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x790EE00F,  9253, 0x90EE0019, 78.57292, 8.052939, 3.867666, -0.9954242, 0, 0, -0.0955544,  True, '2019-02-10 00:00:00'); /* Wily Monouga */
