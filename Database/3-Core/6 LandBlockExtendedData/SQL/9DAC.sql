...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x79DAC008,   213, 0x9DAC0031, 156.7536, 17.69891, 52, -0.2487246, 0, 0, -0.9685743,  True, '2019-02-10 00:00:00'); /* Olthoi Nymph */
/* @teleloc 0x9DAC0031 [156.753600 17.698910 52.000000] -0.248725 0.000000 0.000000 -0.968574 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x79DAC009,  1758, 0x9DAC0004, 2.027142, 92.10642, 127.3695, 0.7241002, 0, 0, -0.6896948,  True, '2019-02-10 00:00:00'); /* Shadow */
/* @teleloc 0x9DAC0004 [2.027142 92.106420 127.369500] 0.724100 0.000000 0.000000 -0.689695 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x79DAC00A,   217, 0x9DAC002F, 123.3414, 147.0786, 82.0349, 0.551436, 0, 0, -0.8342172,  True, '2019-02-10 00:00:00'); /* Gold Phyntos Wasp */
