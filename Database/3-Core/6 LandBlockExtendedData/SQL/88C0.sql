...
VALUES (0x788C0001,  1154, 0x88C0003B, 183.9743, 59.85778, 101.0054, -0.258787, 0, 0, -0.9659344, False, '2019-02-10 00:00:00'); /* Linkable Monster Generator */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x788C0003, 22520, 0x88C00026, 118.6091, 136.4348, 55.95787, 0.6917849, 0, 0, -0.7221037,  True, '2019-02-10 00:00:00'); /* Tusker Redeemer */
/* @teleloc 0x88C00026 [118.609100 136.434800 55.957870] 0.691785 0.000000 0.000000 -0.722104 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x788C0004,  9252, 0x88C00021, 118.232, 18.19452, 98.68696, -0.4090797, 0, 0, -0.9124987,  True, '2019-02-10 00:00:00'); /* Ferocious Monouga */
/* @teleloc 0x88C00021 [118.232000 18.194520 98.686960] -0.409080 0.000000 0.000000 -0.912499 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x788C0005,   199, 0x88C0001A, 85.0134, 30.95836, 102.3457, 0.5, 0, 0, -0.8660254,  True, '2019-02-10 00:00:00'); /* Magma Golem */
/* @teleloc 0x88C0001A [85.013400 30.958360 102.345700] 0.500000 0.000000 0.000000 -0.866025 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x788C0006,   199, 0x88C00019, 88.12833, 21.0358, 102.913, 0.9238795, 0, 0, -0.3826835,  True, '2019-02-10 00:00:00'); /* Magma Golem */
/* @teleloc 0x88C00019 [88.128330 21.035800 102.913000] 0.923880 0.000000 0.000000 -0.382684 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x788C0007,  7105, 0x88C00008, 13.69684, 173.428, 68.09003, 0.8850931, 0, 0, -0.465414,  True, '2019-02-10 00:00:00'); /* White Phyntos Wasp */
/* @teleloc 0x88C00008 [13.696840 173.428000 68.090030] 0.885093 0.000000 0.000000 -0.465414 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x788C0008,  7105, 0x88C00008, 20.11155, 168.3153, 68.09003, 0.8850931, 0, 0, -0.465414,  True, '2019-02-10 00:00:00'); /* White Phyntos Wasp */
